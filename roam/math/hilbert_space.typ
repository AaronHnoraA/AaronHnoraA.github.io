...
#theorem[
在有限维内积空间中，所有柯西序列均收敛于该空间内的某个向量。因此，有限维内积空间(#note("20260127T000000-inner-product-space")[Inner Product Space])天然是完备的，即有限维内积空间即为希尔伯特空间。
]

...
source: "roam/project/UNSW/ISO(202603)/meeting.typ"
---
...
>
>   其一，*语言统一*：Strassen 的 bilinear map 语言、Euan note 中的 Krull–Schmidt 语言、项目最终要写的 $U \times V \times W$ 群作用语言，要放进同一个字典里。
>
>   其二，*关键 iff 的证明封口*：
>   $ A ≅ B ⟺ A ⊕ B $

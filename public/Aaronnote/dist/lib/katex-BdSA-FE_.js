...
}, t = /([A-Z])/g, n = (e) => e.replace(t, "-$1").toLowerCase(), r = {
	"&": "&amp;",
	">": "&gt;",
	"<": "&lt;",
	"\"": "&quot;",
	"'": "&#x27;"
}, i = /[&><"']/g, a = (e) => String(e).replace(i, (e) => r[e]), o = (e) => e.type === "ordgroup" || e.type === "color" ? e.body.length === 1 ? o(e.body[0]) : e : e.type === "font" ? o(e.body) : e, s = new Set([
	"mathord",
	"textord",
	"atom"
]), c = (e) => s.has(o(e).type), l = (e) => {
...
function f(e) {
	return e.default === void 0 ? d(Array.isArray(e.type) ? e.type[0] : e.type) : e.default;
}
function p(e, t, n, r) {
	var i = n[t];
	e[t] = i === void 0 ? f(r) : r.processor ? r.processor(i) : i;
}
var m = class {
	constructor(e) {
	...
	reportNonstrict(t, n, r) {
		...
		if (typeof i == "function" && (i = i(t, n, r)), !(!i || i === "ignore")) {
			if (i === !0 || i === "error") throw new e("LaTeX-incompatible input and strict mode is set to 'error': " + (n + " [" + t + "]"), r);
...
}, g = 0, _ = 1, v = 2, y = 3, b = 4, x = 5, S = 6, C = 7, w = [
	new h(g, 0, !1),
	new h(_, 0, !0),
	new h(v, 1, !1),
	new h(y, 1, !0),
...
function se(e) {
	for (var t = 0; t < oe.length; t++) for (var n = oe[t], r = 0; r < n.blocks.length; r++) {
		var i = n.blocks[r];
...
var ce = [];
oe.forEach((e) => e.blocks.forEach((e) => ce.push(...e)));
function le(e) {
	for (var t = 0; t < ce.length; t += 2) if (e >= ce[t] && e <= ce[t + 1]) return !0;
	return !1;
}
var E = (e) => e + " " + e, ue = 80, de = function(e, t) {
	...
	switch (e) {
		...
		case "sqrtSize4":
			r = he(t, ue);
			break;
		case "sqrtTall": r = _e(t, ue, n);
	}
	return r;
}, ye = function(e, t) {
	switch (e) {
		case "⎜": return E("M291 0 H417 V" + t + " H291z");
		case "∣": return E("M145 0 H188 V" + t + " H145z");
		case "∥": return E("M145 0 H188 V" + t + " H145z") + E("M367 0 H410 V" + t + " H367z");
		case "⎟": return E("M457 0 H583 V" + t + " H457z");
		case "⎢": return E("M319 0 H403 V" + t + " H319z");
		case "⎥": return E("M263 0 H347 V" + t + " H263z");
		case "⎪": return E("M384 0 H504 V" + t + " H384z");
		case "⏐": return E("M312 0 H355 V" + t + " H312z");
		case "‖": return E("M257 0 H300 V" + t + " H257z") + E("M478 0 H521 V" + t + " H478z");
		default: return "";
	}
}, be = {
	...
	leftlinesegment: E("M40 281 V428 H0 V94 H40 V241 H400000 v40z"),
	leftbracketunder: E("M0 0 h120 V290 H399995 v120 H0z"),
	leftbracketover: E("M0 440 h120 V150 H399995 v-120 H0z"),
	leftmapsto: E("M40 281 V448H0V74H40V241H400000v40z"),
	leftToFrom: "M0 147h400000v40H0zm0 214c68 40 115.7 95.7 143 167h22c15.3 0 23\n-.3 23-1 0-1.3-5.3-13.7-16-37-18-35.3-41.3-69-70-101l-7-8h399905v-40H95l7-8\nc28.7-32 52-65.7 70-101 10.7-23.3 16-35.7 16-37 0-.7-7.7-1-23-1h-22C115.7 265.3\n 68 321 0 361zm0-174v-40h399900v40zm100 154v40h399900v-40z",
	longequal: E("M0 50 h400000 v40H0z m0 194h40000v40H0z"),
	...
	rightlinesegment: E("M399960 241 V94 h40 V428 h-40 V281 H0 v-40z"),
	rightbracketunder: E("M399995 0 h-120 V290 H0 v120 H400000z"),
	rightbracketover: E("M399995 440 h-120 V150 H0 v-120 H399995z"),
...
var Ce = class {
	...
	return typeof e != "string" && (e = e.unit), e in we || e in Te || e === "ex";
}, D = function(t, n) {
	var r;
	if (t.unit in we) r = we[t.unit] / n.fontMetrics().ptPerEm / n.sizeMultiplier;
	else if (t.unit === "mu") r = n.fontMetrics().cssEmPerMu;
	else {
		var i = n.style.isTight() ? n.havingStyle(n.style.text()) : n;
		if (t.unit === "ex") r = i.fontMetrics().xHeight;
		else if (t.unit === "em") r = i.fontMetrics().quad;
		else throw new e("Invalid unit: '" + t.unit + "'");
	...
	t.className = De(this.classes), Object.assign(t.style, this.style);
	...
	return t;
}, je = /[\s"'>/=\x00-\x1f]/, Me = function(t) {
	var n = "<" + t;
	this.classes.length && (n += " class=\"" + a(De(this.classes)) + "\"");
	var r = Oe(this.style);
	r && (n += " style=\"" + a(r) + "\"");
	for (var i of Object.keys(this.attributes)) {
		if (je.test(i)) throw new e("Invalid attribute name '" + i + "'");
		n += " " + i + "=\"" + a(this.attributes[i]) + "\"";
	}
	n += ">";
	...
	constructor(e, t, n, r) {
		this.children = void 0, this.attributes = void 0, this.classes = void 0, this.height = void 0, this.depth = void 0, this.width = void 0, this.maxFontSize = void 0, this.style = void 0, this.italic = void 0, ke.call(this, e, n, r), this.children = t || [];
	}
	setAttribute(e, t) {
		this.attributes[e] = t;
	}
	...
	toNode() {
		return Ae.call(this, "span");
	}
	toMarkup() {
		return Me.call(this, "span");
	}
}, Pe = class {
	constructor(e, t, n, r) {
		this.children = void 0, this.attributes = void 0, this.classes = void 0, this.height = void 0, this.depth = void 0, this.maxFontSize = void 0, this.style = void 0, ke.call(this, t, r), this.children = n || [], this.setAttribute("href", e);
	}
	setAttribute(e, t) {
		this.attributes[e] = t;
	}
	...
	toMarkup() {
		var e = "<img src=\"" + a(this.src) + "\"" + (" alt=\"" + a(this.alt) + "\""), t = Oe(this.style);
		return t && (e += " style=\"" + a(t) + "\""), e += "'/>", e;
	}
}, Ie = {
	î: "ı̂",
	ï: "ı̈",
	...
	constructor(e, t, n, r, i, a, o, s) {
		...
		var c = se(this.text.charCodeAt(0));
		c && this.classes.push(c + "_fallback"), /[îïíì]/.test(this.text) && (this.text = Ie[this.text]);
	}
	hasClass(e) {
		return this.classes.includes(e);
	}
	toNode() {
		...
		return this.italic > 0 && (t = document.createElement("span"), t.style.marginRight = O(this.italic)), this.classes.length > 0 && (t ||= document.createElement("span"), t.className = De(this.classes)), Object.keys(this.style).length > 0 && (t ||= document.createElement("span"), Object.assign(t.style, this.style)), t ? (t.appendChild(e), t) : e;
	}
	toMarkup() {
		var e = !1, t = "<span";
		this.classes.length && (e = !0, t += " class=\"", t += a(De(this.classes)), t += "\"");
		var n = "";
		this.italic > 0 && (n += "margin-right:" + O(this.italic) + ";"), n += Oe(this.style), n && (e = !0, t += " style=\"" + a(n) + "\"");
		var r = a(this.text);
	...
	toMarkup() {
		...
		for (var t of Object.keys(this.attributes)) e += " " + t + "=\"" + a(this.attributes[t]) + "\"";
		e += ">";
	...
	toNode() {
		...
		return this.alternate ? e.setAttribute("d", this.alternate) : e.setAttribute("d", be[this.pathName]), e;
	}
	toMarkup() {
		return this.alternate ? "<path d=\"" + a(this.alternate) + "\"/>" : "<path d=\"" + a(be[this.pathName]) + "\"/>";
	}
}, Be = class {
	constructor(e) {
...
var Ue = (e) => e instanceof Ne || e instanceof Pe || e instanceof Ce, We = {
	"AMS-Regular": {
		32: [
			0,
			0,
...
function Je(e, t, n) {
	if (!We[t]) throw Error("Font metrics not found for font: " + t + ".");
	var r = e.charCodeAt(0), i = We[t][r];
	if (!i && e[0] in Ke && (r = Ke[e[0]].charCodeAt(0), i = We[t][r]), !i && n === "text" && le(r) && (i = We[t][77]), i) return {
		depth: i[0],
		height: i[1],
		italic: i[2],
		skew: i[3],
...
function Xe(e) {
	var t = e >= 5 ? 0 : e >= 3 ? 1 : 2;
	if (!Ye[t]) {
		var n = Ye[t] = { cssEmPerMu: Ge.quad[t] / 18 };
		for (var r in Ge) Ge.hasOwnProperty(r) && (n[r] = Ge[r][t]);
	}
	return Ye[t];
}
var k = {
...
for (var V, ft = 0; ft < lt.length; ft++) {
	var H = lt.charAt(ft);
	V = String.fromCharCode(55349, 56320 + ft), A(j, N, L, H, V), A(M, N, B, H, V), V = String.fromCharCode(55349, 56372 + ft), A(j, N, L, H, V), A(M, N, B, H, V), V = String.fromCharCode(55349, 56424 + ft), A(j, N, L, H, V), A(M, N, B, H, V), V = String.fromCharCode(55349, 56580 + ft), A(j, N, L, H, V), A(M, N, B, H, V), V = String.fromCharCode(55349, 56684 + ft), A(j, N, L, H, V), A(M, N, B, H, V), V = String.fromCharCode(55349, 56736 + ft), A(j, N, L, H, V), A(M, N, B, H, V), V = String.fromCharCode(55349, 56788 + ft), A(j, N, L, H, V), A(M, N, B, H, V), V = String.fromCharCode(55349, 56840 + ft), A(j, N, L, H, V), A(M, N, B, H, V), V = String.fromCharCode(55349, 56944 + ft), A(j, N, L, H, V), A(M, N, B, H, V), ft < 26 && (V = String.fromCharCode(55349, 56632 + ft), A(j, N, L, H, V), A(M, N, B, H, V), V = String.fromCharCode(55349, 56476 + ft), A(j, N, L, H, V), A(M, N, B, H, V));
}
V = String.fromCharCode(55349, 56668), A(j, N, L, "k", V), A(M, N, B, "k", V);
for (var pt = 0; pt < 10; pt++) {
	var mt = pt.toString();
	V = String.fromCharCode(55349, 57294 + pt), A(j, N, L, mt, V), A(M, N, B, mt, V), V = String.fromCharCode(55349, 57314 + pt), A(j, N, L, mt, V), A(M, N, B, mt, V), V = String.fromCharCode(55349, 57324 + pt), A(j, N, L, mt, V), A(M, N, B, mt, V), V = String.fromCharCode(55349, 57334 + pt), A(j, N, L, mt, V), A(M, N, B, mt, V);
}
for (var ht = "ÐÞþ", gt = 0; gt < ht.length; gt++) {
	var _t = ht.charAt(gt);
	A(j, N, L, _t, _t), A(M, N, B, _t, _t);
}
var vt = {
	mathClass: "mathbf",
	textClass: "textbf",
	...
	var n = t.charCodeAt(0), r = t.charCodeAt(1), i = (n - 55296) * 1024 + (r - 56320) + 65536;
	if (119808 <= i && i < 120484) return At[Math.floor((i - 119808) / 26)];
	if (120782 <= i && i <= 120831) return jt[Math.floor((i - 120782) / 10)];
	if (i === 120485 || i === 120486) return At[0];
	if (120486 < i && i < 120782) return St;
	throw new e("Unsupported character: " + t);
}, Nt = function(e, t, n) {
	if (k[n][e]) {
		var r = k[n][e].replace;
		r && (e = r);
	...
	var a = Nt(e, t, n), o = a.metrics;
	e = a.value;
	var s;
	if (o) {
		var c = o.italic;
		(n === "text" || r && r.font === "mathit") && (c = 0), s = new Le(e, o.height, o.depth, c, o.skew, o.width, i);
	} else typeof console < "u" && console.warn("No character metrics " + ("for '" + e + "' in style '" + t + "' and mode '" + n + "'")), s = new Le(e, 0, 0, 0, 0, 0, i);
	if (r) {
	...
	return r === void 0 && (r = []), n.font === "boldsymbol" && Nt(e, "Main-Bold", t).metrics ? Pt(e, "Main-Bold", t, n, r.concat(["mathbf"])) : e === "\\" || k[t][e].font === "main" ? Pt(e, "Main-Regular", t, n, r) : Pt(e, "AMS-Regular", t, n, r.concat(["amsrm"]));
}, It = function(e, t, n) {
	return n !== "textord" && Nt(e, "Math-BoldItalic", t).metrics ? {
	...
	if (f) return Pt(i, f, r, t, a.concat(p));
	if (d) {
		var h, g;
		if (d === "boldsymbol") {
			var _ = It(i, r, n);
			h = _.fontName, g = [_.fontClass];
		} else u ? (h = Yt[o].fontName, g = [o]) : (h = Jt(s, c, l), g = [
			s,
			c,
			l
		]);
		if (Nt(i, h, r).metrics) return Pt(i, h, r, t, a.concat(g));
		if (nt.hasOwnProperty(i) && h.slice(0, 10) === "Typewriter") {
			for (var v = [], y = 0; y < i.length; y++) v.push(Pt(i[y], h, r, t, a.concat(g)));
			return Wt(v);
		}
	}
	if (n === "mathord") return Pt(i, "Math-Italic", r, t, a.concat(["mathnormal"]));
	if (n === "textord") {
		var b = k[r][i] && k[r][i].font;
		if (b === "ams") return Pt(i, Jt("amsrm", c, l), r, t, a.concat("amsrm", c, l));
		if (b === "main" || !b) return Pt(i, Jt("textrm", c, l), r, t, a.concat(c, l));
		var x = Jt(b, c, l);
		return Pt(i, x, r, t, a.concat(x, c, l));
	} else throw Error("unexpected type: " + n + " in makeOrd");
}, Rt = (e, t) => {
	if (De(e.classes) !== De(t.classes) || e.skew !== t.skew || e.maxFontSize !== t.maxFontSize || e.italic !== 0 && e.hasClass("mathnormal")) return !1;
	...
	for (var t = 0; t < e.length - 1; t++) {
		var n = e[t], r = e[t + 1];
		n instanceof Le && r instanceof Le && Rt(n, r) && (n.text += r.text, n.height = Math.max(n.height, r.height), n.depth = Math.max(n.depth, r.depth), n.italic = r.italic, e.splice(t + 1, 1), t--);
	}
	return e;
}, Bt = function(e) {
	...
	var i = new Ne(e, t, n, r);
	return Bt(i), i;
}, Vt = (e, t, n, r) => new Ne(e, t, n, r), Ht = function(e, t, n) {
	var r = U([e], [], t);
	return r.height = Math.max(n || t.fontMetrics().defaultRuleThickness, t.minRuleThickness), r.style.borderBottomWidth = O(r.height), r.maxFontSize = 1, r;
}, Ut = function(e, t, n, r) {
	var i = new Pe(e, t, n, r);
	return Bt(i), i;
}, Wt = function(e) {
	var t = new Ce(e);
	return Bt(t), t;
}, Gt = function(e, t) {
	return e instanceof Ce ? U([], [e], t) : e;
}, Kt = function(e) {
	...
	for (var { children: n, depth: r } = Kt(e), i = 0, a = 0; a < n.length; a++) {
		var o = n[a];
		if (o.type === "elem") {
			var s = o.elem;
	...
	for (var l = [], u = r, d = r, f = r, p = 0; p < n.length; p++) {
		...
		if (m.type === "kern") f += m.size;
			...
			var h = m.elem, g = m.wrapperClasses || [], _ = m.wrapperStyle || {}, v = U(g, [c, h], void 0, _);
			v.style.top = O(-i - f - h.depth), m.marginLeft && (v.style.marginLeft = m.marginLeft), m.marginRight && (v.style.marginRight = m.marginRight), l.push(v), f += h.height + h.depth;
		}
	...
	if (u < 0) {
		var x = U(["vlist"], [U([], [])]);
		x.style.height = O(-u), b = [U(["vlist-r"], [y, U(["vlist-s"], [new Le("​")])]), U(["vlist-r"], [x])];
	} else b = [U(["vlist-r"], [y])];
	var S = U(["vlist-t"], b);
	return b.length === 2 && S.classes.push("vlist-t2"), S.height = d, S.depth = -u, S;
}, qt = (e, t) => {
	var n = U(["mspace"], [], t), r = D(e, t);
	...
	var [n, r, i] = Xt[e], a = Vt(["overlay"], [new Re([new ze(n)], {
		width: O(r),
		height: O(i),
		style: "width:" + O(r),
	...
	return a.height = i, a.style.height = O(i), a.style.width = O(r), a;
}, G = {
	number: 3,
	unit: "mu"
}, Qt = {
...
var sn = function(e) {
	...
	if (e.length === 1) {
		var l = e[0];
		l.type === "sizing" ? c = t.havingSize(l.size) : l.type === "styling" && (c = t.havingStyle(un[l.style]));
	}
	var u = U([r[0] || "leftmost"], [], t), d = U([r[1] || "rightmost"], [], t), f = n === "root";
	return pn(i, (e, t) => {
		var n = t.classes[0], r = e.classes[0];
		n === "mbin" && ln.has(r) ? t.classes[0] = "mord" : r === "mbin" && cn.has(n) && (e.classes[0] = "mord");
	}, { node: u }, d, f), pn(i, (e, t) => {
		var n = gn(t), r = gn(e), i = n && r ? e.hasClass("mtight") ? tn[n]?.[r] : en[n]?.[r] : null;
		if (i) return qt(i, c);
	}, { node: u }, d, f), i;
	...
	for (var a = 0; a < e.length; a++) {
		...
		c ? n.node = o : i && o.hasClass("newline") && (n.node = U(["leftmost"])), n.insertAfter = ((t) => (n) => {
			e.splice(t + 1, 0, n), a++;
		})(a);
	}
	r && e.pop();
}, mn = function(e) {
	return e instanceof Ce || e instanceof Pe || e instanceof Ne && e.hasClass("enclosing") ? e : null;
}, hn = function(e, t) {
	var n = mn(e);
	if (n) {
		var r = n.children;
		if (r.length) {
			if (t === "right") return hn(r[r.length - 1], "right");
			if (t === "left") return hn(r[0], "left");
		}
	}
	return e;
}, gn = function(e, t) {
	return e ? (t && (e = hn(e, t)), dn[e.classes[0]] || null) : null;
}, _n = function(e, t) {
	...
	if (rn[t.type]) {
		var i = rn[t.type](t, n);
		if (r && n.size !== r.size) {
			i = U(n.sizingClasses(r), [i], n);
			var a = n.sizeMultiplier / r.sizeMultiplier;
			i.height *= a, i.depth *= a;
		}
		return i;
	} else throw new e("Got group of unknown type: '" + t.type + "'");
};
function vn(e, t) {
	var n = U(["base"], e, t), r = U(["strut"]);
...
function yn(e, t) {
	...
	for (var a = [], o = [], s = 0; s < r.length; s++) if (o.push(r[s]), r[s].hasClass("mbin") || r[s].hasClass("mrel") || r[s].hasClass("allowbreak")) {
		...
		c || (a.push(vn(o, t)), o = []);
	} else r[s].hasClass("newline") && (o.pop(), o.length > 0 && (a.push(vn(o, t)), o = []), a.push(r[s]));
	o.length > 0 && a.push(vn(o, t));
	var l;
	n ? (l = vn(fn(n, t, !0), t), l.classes = ["tag"], a.push(l)) : i && a.push(i);
	var u = U(["katex-html"], a);
	if (u.setAttribute("aria-hidden", "true"), l) {
		var d = l.children[0];
		d.style.height = O(u.height + u.depth), u.depth && (d.style.verticalAlign = O(-u.depth));
	}
	return u;
}
function bn(e) {
...
var Y = class {
	...
	toNode() {
		...
		for (var n = 0; n < this.children.length; n++) if (this.children[n] instanceof X && this.children[n + 1] instanceof X) {
			for (var r = this.children[n].toText() + this.children[++n].toText(); this.children[n + 1] instanceof X;) r += this.children[++n].toText();
			e.appendChild(new X(r).toNode());
		} else e.appendChild(this.children[n].toNode());
		return e;
	}
	toMarkup() {
		var e = "<" + this.type;
		for (var t in this.attributes) Object.prototype.hasOwnProperty.call(this.attributes, t) && (e += " " + t + "=\"", e += a(this.attributes[t]), e += "\"");
		this.classes.length > 0 && (e += " class =\"" + a(De(this.classes)) + "\""), e += ">";
		for (var n = 0; n < this.children.length; n++) e += this.children[n].toMarkup();
...
}, Sn = new Set(["\\imath", "\\jmath"]), Cn = new Set(["mrow", "mtable"]), wn = function(e, t, n) {
	return k[t][e] && k[t][e].replace && e.charCodeAt(0) !== 55349 && !(nt.hasOwnProperty(e) && n && (n.fontFamily && n.fontFamily.slice(4, 6) === "tt" || n.font && n.font.slice(4, 6) === "tt")) && (e = k[t][e].replace), new X(e);
}, Tn = function(e) {
...
var kn = function(e, t, n) {
	...
	for (var i = [], a, o = 0; o < e.length; o++) {
		...
		if (s instanceof Y && a instanceof Y) {
			if (s.type === "mtext" && a.type === "mtext" && s.getAttribute("mathvariant") === a.getAttribute("mathvariant")) {
				...
				a.children.push(...s.children);
				continue;
			} else if (On(s) && a.type === "mn") {
				a.children.push(...s.children);
				continue;
			} else if (s.type === "mn" && On(a)) s.children = [...a.children, ...s.children], i.pop();
			else if ((s.type === "msup" || s.type === "msub") && s.children.length >= 1 && (a.type === "mn" || On(a))) {
				var c = s.children[0];
				c instanceof Y && c.type === "mn" && (c.children = [...a.children, ...c.children], i.pop());
			} else if (a.type === "mi" && a.children.length === 1) {
				var l = a.children[0];
				if (l instanceof X && l.text === "̸" && (s.type === "mo" || s.type === "mi" || s.type === "mn")) {
					var u = s.children[0];
					u instanceof X && u.text.length > 0 && (u.text = u.text.slice(0, 1) + "̸" + u.text.slice(1), i.pop());
				}
			}
		}
		i.push(s), a = s;
	...
	if (!t) return new Y("mrow");
	if (an[t.type]) return an[t.type](t, n);
	throw new e("Got group of unknown type: '" + t.type + "'");
};
function jn(e, t, n, r, i) {
	var a = kn(e, n), o = a.length === 1 && a[0] instanceof Y && Cn.has(a[0].type) ? a[0] : new Y("mrow", a), s = new Y("annotation", [new X(t)]);
	s.setAttribute("encoding", "application/x-tex");
	var c = new Y("math", [new Y("semantics", [o, s])]);
	return c.setAttribute("xmlns", "http://www.w3.org/1998/Math/MathML"), r && c.setAttribute("display", "block"), U([i ? "katex" : "katex-mathml"], [c]);
}
var Mn = [
	[
		1,
	...
	return t.size < 2 ? e : Mn[e - 1][t.size - 1];
}, Fn = class e {
	constructor(t) {
		this.style = void 0, this.color = void 0, this.size = void 0, this.textSize = void 0, this.phantom = void 0, this.font = void 0, this.fontFamily = void 0, this.fontWeight = void 0, this.fontShape = void 0, this.sizeMultiplier = void 0, this.maxSize = void 0, this.minRuleThickness = void 0, this._fontMetrics = void 0, this.style = t.style, this.color = t.color, this.size = t.size || e.BASESIZE, this.textSize = t.textSize || this.size, this.phantom = !!t.phantom, this.font = t.font || "", this.fontFamily = t.fontFamily || "", this.fontWeight = t.fontWeight || "", this.fontShape = t.fontShape || "", this.sizeMultiplier = Nn[this.size - 1], this.maxSize = t.maxSize, this.minRuleThickness = t.minRuleThickness, this._fontMetrics = void 0;
	}
	extend(t) {
		var n = {
			style: this.style,
	...
	havingSize(e) {
		return this.size === e && this.textSize === e ? this : this.extend({
			...
			size: e,
			textSize: e,
			sizeMultiplier: Nn[e - 1]
		});
	}
	havingBaseStyle(t) {
		t ||= this.style.text();
		var n = Pn(e.BASESIZE, t);
	...
	fontMetrics() {
		return this._fontMetrics ||= Xe(this.size), this._fontMetrics;
	}
	getColor() {
...
var In = function(e) {
	...
	var r = In(n), i;
	return n.output === "mathml" ? jn(e, t, r, n.displayMode, !0) : (i = n.output === "html" ? U(["katex"], [yn(e, r)]) : U(["katex"], [jn(e, t, r, n.displayMode, !1), yn(e, r)]), Ln(i, n));
}, zn = function(e, t, n) {
	return Ln(U(["katex"], [yn(e, In(n))]), n);
}, Bn = {
	widehat: "^",
	widecheck: "ˇ",
	widetilde: "~",
	...
	var t = new Y("mo", [new X(Bn[e.replace(/^\\/, "")])]);
	...
	return r.height = a, r.style.height = O(a), i > 0 && (r.style.minWidth = O(i)), r;
}, Gn = function(e, t, n, r, i) {
	var a, o = e.height + e.depth + n + r;
	if (/fbox|color|angl/.test(t)) {
		if (a = U(["stretchy", t], [], i), t === "fbox") {
			var s = i.color && i.getColor();
			s && (a.style.borderColor = s);
		}
	} else {
		var c = [];
		/^[bx]cancel$/.test(t) && c.push(new Be({
			x1: "0",
			y1: "0",
			x2: "100%",
			y2: "100%",
			"stroke-width": "0.046em"
		})), /^x?cancel$/.test(t) && c.push(new Be({
			x1: "0",
			y1: "100%",
			x2: "100%",
			y2: "0",
	...
	return a.height = o, a.style.height = O(o), a;
}, Kn = {
	bin: 1,
	close: 1,
	inner: 1,
...
function Xn(e) {
	return e && (e.type === "atom" || qn.hasOwnProperty(e.type)) ? e : null;
}
var Zn = (e) => {
	if (e instanceof Le) return e;
	if (Ue(e) && e.children.length === 1) return Zn(e.children[0]);
}, Qn = (e, t) => {
	var n, r, i;
	e && e.type === "supsub" ? (r = Q(e.base, "accent"), n = r.base, e.base = n, i = He(J(e, t)), e.base = r) : (r = Q(e, "accent"), n = r.base);
	var a = J(n, t.havingCrampedStyle()), o = r.isShifty && c(n), s = 0;
	o && (s = Zn(a)?.skew ?? 0);
	var l = r.label === "\\c", u = l ? a.height + a.depth : Math.min(a.height, t.fontMetrics().xHeight), d;
	if (r.isStretchy) d = Wn(r, t), d = W({
		...
		var f, p;
		r.label === "\\vec" ? (f = Zt("vec", t), p = Xt.vec[1]) : (f = Lt({
			type: "textord",
			mode: r.mode,
			text: r.label
		}, t, "textord"), f = Ve(f), f.italic = 0, p = f.width, l && (u += f.depth)), d = U(["accent-body"], [f]);
		var m = r.label === "\\textcircled";
		m && (d.classes.push("accent-full"), u = a.height);
		var h = s;
		m || (h -= p / 2), d.style.left = O(h), r.label === "\\textcircled" && (d.style.top = ".2em"), d = W({
			positionType: "firstBaseline",
			children: [
				{
					type: "elem",
	...
	var g = U(["mord", "accent"], [d], t);
	return i ? (i.children[0] = g, i.height = Math.max(g.height, i.height), i.classes[0] = "mord", i) : g;
}, $n = (e, t) => {
	var n = e.isStretchy ? Vn(e.label) : new Y("mo", [wn(e.label, e.mode)]), r = new Y("mover", [Z(e.base, t), n]);
...
K({
	...
	props: { numArgs: 1 },
	handler: (e, t) => {
		var n = sn(t[0]), r = !er.test(e.funcName), i = !r || e.funcName === "\\widehat" || e.funcName === "\\widetilde" || e.funcName === "\\widecheck";
		return {
			type: "accent",
			mode: e.parser.mode,
			label: e.funcName,
	...
	htmlBuilder: (e, t) => {
		var n = J(e.base, t), r = Wn(e, t), i = e.label === "\\utilde" ? .12 : 0;
		return U(["mord", "accentunder"], [W({
			positionType: "top",
	...
	mathmlBuilder: (e, t) => {
		var n = Vn(e.label), r = new Y("munder", [Z(e.base, t), n]);
...
K({
	...
	htmlBuilder(e, t) {
		var n = t.style, r = t.havingStyle(n.sup()), i = Gt(J(e.body, r, t), t), a = e.label.slice(0, 2) === "\\x" ? "x" : "cd";
		i.classes.push(a + "-arrow-pad");
		var o;
		e.below && (r = t.havingStyle(n.sub()), o = Gt(J(e.below, r, t), t), o.classes.push(a + "-arrow-pad"));
		var s = Wn(e, t), c = -t.fontMetrics().axisHeight + .5 * s.height, l = -t.fontMetrics().axisHeight - .5 * s.height - .111;
	...
	mathmlBuilder(e, t) {
		...
		} else e.below ? r = new Y("munder", [n, tr(Z(e.below, t))]) : (r = tr(), r = new Y("mover", [n, r]));
		return r;
	}
});
function nr(e, t) {
	var n = fn(e.body, t, !0);
	return U([e.mclass], n, t);
}
function rr(e, t) {
	var n, r = kn(e.body, t);
...
K({
	...
	props: { numArgs: 2 },
	handler(e, t) {
		var { parser: n, funcName: r } = e, i = t[1], a = t[0], o = r === "\\stackrel" ? "mrel" : ir(i), s = {
			type: "op",
			mode: i.mode,
			limits: !0,
	...
	htmlBuilder(e, t) {
		var n = fn(e.body, t, !0), r = U([e.mclass], n, t);
		return r.style.textShadow = "0.02em 0.01em 0.04px", r;
	},
	mathmlBuilder(e, t) {
		var n = new Y("mstyle", kn(e.body, t));
...
var ar = {
	...
	style: "display",
	resetFont: !0
}), sr = (e) => e.type === "textord" && e.text === "@", cr = (e, t) => (e.type === "mathord" || e.type === "atom") && e.text === t;
function lr(e, t, n) {
	var r = ar[e];
	switch (r) {
		case "\\\\cdrightarrow":
...
function ur(t) {
	...
	for (t.gullet.beginGroup(), t.gullet.macros.set("\\cr", "\\\\\\relax"), t.gullet.beginGroup();;) {
		...
		if (r === "&" || r === "\\\\") t.consume();
			...
			break;
		} else throw new e("Expected \\\\ or \\cr or \\end", t.nextToken);
	}
	for (var i = [], a = [i], o = 0; o < n.length; o++) {
		for (var s = n[o], c = or(), l = 0; l < s.length; l++) if (!sr(s[l])) c.body.push(s[l]);
		else {
			i.push(c), l += 1;
			var u = Yn(s[l]).text, d = [, ,];
			if (d[0] = {
				...
				for (var p = !0, m = l + 1; m < s.length; m++) {
					...
					if (sr(s[m])) throw new e("Missing a " + u + " character to complete a CD arrow.", s[m]);
					d[f].body.push(s[m]);
				}
				if (p) throw new e("Missing a " + u + " character to complete a CD arrow.", s[l]);
			}
			else throw new e("Expected one of \"<>AV=|.\" after @", s[l]);
			var h = {
				type: "styling",
				body: [lr(u, d, t)],
				mode: "math",
		...
		o % 2 == 0 ? i.push(c) : i.shift(), i = [], a.push(i);
	}
	return t.gullet.endGroup(), t.gullet.endGroup(), {
		...
		hLinesBeforeRow: Array(a.length + 1).fill([])
	};
}
K({
	type: "cdlabel",
	...
	htmlBuilder(e, t) {
		var n = t.havingStyle(t.style.sup()), r = Gt(J(e.label, n, t), t);
		return r.classes.push("cd-label-" + e.side), r.style.bottom = O(.8 - r.depth), r.height = 0, r.depth = 0, r;
	},
	mathmlBuilder(e, t) {
		var n = new Y("mrow", [Z(e.label, t)]);
	...
	htmlBuilder(e, t) {
		var n = Gt(J(e.fragment, t), t);
		return n.classes.push("cd-vert-arrow"), n;
	},
	mathmlBuilder(e, t) {
		return new Y("mrow", [Z(e.fragment, t)]);
	}
}), K({
	type: "textord",
	names: ["\\@char"],
	...
	handler(t, n) {
		for (var { parser: r } = t, i = Q(n[0], "ordgroup").body, a = "", o = 0; o < i.length; o++) {
			var s = Q(i[o], "textord");
			a += s.text;
		}
		var c = parseInt(a), l;
		if (isNaN(c)) throw new e("\\@char has non-numeric argument " + a);
		if (c < 0 || c >= 1114111) throw new e("\\@char with invalid code point " + a);
...
var dr = (e, t) => Wt(fn(e.body, t.withColor(e.color), !1)), fr = (e, t) => {
	var n = new Y("mstyle", kn(e.body, t.withColor(e.color)));
...
K({
	...
	htmlBuilder(e, t) {
		var n = U(["mspace"], [], t);
		return e.newLine && (n.classes.push("newline"), e.size && (n.style.marginTop = O(D(e.size, t)))), n;
	},
	mathmlBuilder(e, t) {
		var n = new Y("mspace");
		return e.newLine && (n.setAttribute("linebreak", "newline"), e.size && n.setAttribute("height", O(D(e.size, t)))), n;
	}
});
var pr = {
	"\\global": "\\global",
	...
	var n = t.text;
	if (/^(?:[\\{}$&#^_]|EOF)$/.test(n)) throw new e("Expected a control sequence", t);
	return n;
}, hr = (e) => {
...
K({
	...
	handler(t) {
		...
		n.consumeSpaces();
		var i = n.fetch();
		if (pr[i.text]) return (r === "\\global" || r === "\\\\globallong") && (i.text = pr[i.text]), Q(n.parseFunction(), "internal");
		throw new e("Invalid token after macro prefix", i);
	}
}), K({
	type: "internal",
	names: [
	...
	handler(t) {
		var { parser: n, funcName: r } = t, i = n.gullet.popToken(), a = i.text;
		if (/^(?:[\\{}$&#^_]|EOF)$/.test(a)) throw new e("Expected a control sequence", i);
		for (var o = 0, s, c = [[]]; n.gullet.future().text !== "{";) if (i = n.gullet.popToken(), i.text === "#") {
			if (n.gullet.future().text === "{") {
				s = n.gullet.future(), c[o].push("{");
				break;
			}
			if (i = n.gullet.popToken(), !/^[1-9]$/.test(i.text)) throw new e("Invalid argument number \"" + i.text + "\"");
			if (parseInt(i.text) !== o + 1) throw new e("Argument number \"" + i.text + "\" out of order");
			o++, c.push([]);
		} else if (i.text === "EOF") throw new e("Expected a macro definition");
		else c[o].push(i.text);
		var { tokens: l } = n.gullet.consumeArg();
		return s && l.unshift(s), (r === "\\edef" || r === "\\xdef") && (l = n.gullet.expandTokens(l), l.reverse()), n.gullet.macros.set(a, {
			tokens: l,
			numArgs: o,
			delimiters: c
		}, r === pr[r]), {
	...
	handler(e) {
		var { parser: t, funcName: n } = e, r = mr(t.gullet.popToken());
		return t.gullet.consumeSpaces(), gr(t, r, hr(t), n === "\\\\globallet"), {
			type: "internal",
			mode: t.mode
		};
	}
	...
	handler(e) {
		var { parser: t, funcName: n } = e, r = mr(t.gullet.popToken()), i = t.gullet.popToken(), a = t.gullet.popToken();
		return gr(t, r, a, n === "\\\\globalfuture"), t.gullet.pushToken(a), t.gullet.pushToken(i), {
			type: "internal",
			mode: t.mode
		};
	}
...
var _r = function(e, t, n) {
	var r = Je(k.math[e] && k.math[e].replace || e, t, n);
	if (!r) throw Error("Unsupported symbol " + e + " and font size " + t + ".");
	return r;
}, vr = function(e, t, n, r) {
	var i = n.havingBaseStyle(t), a = U(r.concat(i.sizingClasses(n)), [e], n), o = i.sizeMultiplier / n.sizeMultiplier;
	...
	var o = vr(Pt(e, "Main-Regular", i, r), t, r, a);
	return n && yr(o, r, t), o;
}, xr = function(e, t, n, r) {
	return Pt(e, "Size" + t + "-Regular", n, r);
}, Sr = function(e, t, n, r, i, a) {
	var o = xr(e, t, i, r), s = vr(U(["delimsizing", "size" + t], [o], r), T.TEXT, r, a);
	return n && yr(s, r, T.TEXT), s;
}, Cr = function(e, t, n) {
	return {
		type: "elem",
		elem: U(["delimsizinginner", t === "Size1-Regular" ? "delim-size1" : "delim-size4"], [U([], [Pt(e, t, n)])])
	};
}, wr = function(e, t, n) {
	var r = We["Size4-Regular"][e.charCodeAt(0)] ? We["Size4-Regular"][e.charCodeAt(0)][4] : We["Size1-Regular"][e.charCodeAt(0)][4], i = Vt([], [new Re([new ze("inner", ye(e, Math.round(1e3 * t)))], {
		width: O(r),
		height: O(t),
		style: "width:" + O(r),
	...
	return i.height = t, i.style.height = O(t), i.style.width = O(r), {
		type: "elem",
		elem: i
	};
}, Tr = .008, Er = {
	...
	var p = _r(o, f, i), m = p.height + p.depth, h = _r(c, f, i), g = h.height + h.depth, _ = _r(l, f, i), v = _.height + _.depth, y = 0, b = 1;
	if (s !== null) {
		var x = _r(s, f, i);
	...
	var ee = C / 2 - w, te = [];
	if (u.length > 0) {
		var ne = C - m - v, re = Math.round(C * 1e3), ie = xe(u, Math.round(ne * 1e3)), ae = new ze(u, ie), oe = O(d / 1e3), se = O(re / 1e3), ce = Vt([], [new Re([ae], {
			width: oe,
			height: se,
			viewBox: "0 0 " + d + " " + re
		})], r);
		ce.height = re / 1e3, ce.style.width = oe, ce.style.height = se, te.push({
			type: "elem",
			elem: ce
		});
	} else {
		if (te.push(Cr(l, f, i)), te.push(Er), s === null) {
			var le = C - m - v + 2 * Tr;
			te.push(wr(c, le, r));
		} else {
			var E = (C - m - v - y) / 2 + 2 * Tr;
			te.push(wr(c, E, r)), te.push(Er), te.push(Cr(s, f, i)), te.push(Er), te.push(wr(c, E, r));
		}
		te.push(Er), te.push(Cr(o, f, i));
	}
	var ue = r.havingBaseStyle(T.TEXT);
	return vr(U(["delimsizing", "mult"], [W({
		positionType: "bottom",
		positionData: ee,
		children: te
	})], ue), T.TEXT, r, a);
}, Ar = 80, jr = .08, Mr = function(e, t, n, r, i) {
	return Vt(["hide-tail"], [new Re([new ze(e, ve(e, r, n))], {
		width: "400em",
		height: O(t),
	...
	var n = t.havingBaseSizing(), r = Ur("\\surd", e * n.sizeMultiplier, Vr, n), i = n.sizeMultiplier, a = Math.max(0, t.minRuleThickness - t.fontMetrics().sqrtRuleThickness), o, s, c, l, u;
	return r.type === "small" ? (l = 1e3 + 1e3 * a + Ar, e < 1 ? i = 1 : e < 1.4 && (i = .7), s = (1 + a + jr) / i, c = (1 + a) / i, o = Mr("sqrtMain", s, l, a, t), o.style.minWidth = "0.853em", u = .833 / i) : r.type === "large" ? (l = (1e3 + Ar) * Lr[r.size], c = (Lr[r.size] + a) / i, s = (Lr[r.size] + a + jr) / i, o = Mr("sqrtSize" + r.size, s, l, a, t), o.style.minWidth = "1.02em", u = 1 / i) : (s = e + a + jr, c = e + a, l = Math.floor(1e3 * e + a) + Ar, o = Mr("sqrtTall", s, l, a, t), o.style.minWidth = "0.742em", u = 1.056), o.height = c, o.style.height = O(s), {
		span: o,
		advanceWidth: u,
	...
	2.4,
	3
], Rr = function(t, n, r, i, a) {
	if (t === "<" || t === "\\lt" || t === "⟨" ? t = "\\langle" : (t === ">" || t === "\\gt" || t === "⟩") && (t = "\\rangle"), Pr.has(t) || Ir.has(t)) return Sr(t, n, !1, r, i, a);
	if (Fr.has(t)) return kr(t, Lr[n], !1, r, i, a);
	throw new e("Illegal delimiter: '" + t + "'");
}, zr = [
	{
		type: "small",
	...
	for (var i = Math.min(2, 3 - r.style.size); i < n.length; i++) {
		...
		var o = _r(e, Hr(a), "math"), s = o.height + o.depth;
		if (a.type === "small") {
	...
	var o = Ir.has(e) ? zr : Pr.has(e) ? Vr : Br, s = Ur(e, t, o, r);
	return s.type === "small" ? br(e, s.style, n, r, i, a) : s.type === "large" ? Sr(e, s.size, n, r, i, a) : kr(e, t, n, r, i, a);
	...
	return Wr(e, Math.max(l / 500 * s, 2 * l - c), !0, r, i, a);
}, Kr = {
	"\\bigl": {
		mclass: "mopen",
		size: 1
...
}, qr = new Set(/* @__PURE__ */ "(,\\lparen,),\\rparen,[,\\lbrack,],\\rbrack,\\{,\\lbrace,\\},\\rbrace,\\lfloor,\\rfloor,⌊,⌋,\\lceil,\\rceil,⌈,⌉,<,>,\\langle,⟨,\\rangle,⟩,\\lt,\\gt,\\lvert,\\rvert,\\lVert,\\rVert,\\lgroup,\\rgroup,⟮,⟯,\\lmoustache,\\rmoustache,⎰,⎱,/,\\backslash,|,\\vert,\\|,\\Vert,\\uparrow,\\Uparrow,\\downarrow,\\Downarrow,\\updownarrow,\\Updownarrow,.".split(","));
function Jr(e) {
	return "isMiddle" in e;
}
function Yr(t, n) {
	var r = Xn(t);
	if (r && qr.has(r.text)) return r;
	throw r ? new e("Invalid delimiter '" + r.text + "' after '" + n.funcName + "'", t) : new e("Invalid delimiter type '" + t.type + "'", t);
}
K({
	type: "delimsizing",
	names: [
	...
	handler: (e, t) => {
		...
		return {
			type: "delimsizing",
			mode: e.parser.mode,
			size: Kr[e.funcName].size,
			mclass: Kr[e.funcName].mclass,
			delim: n.text
		};
	},
	htmlBuilder: (e, t) => e.delim === "." ? U([e.mclass]) : Rr(e.delim, e.size, t, e.mode, [e.mclass]),
	mathmlBuilder: (e) => {
		var t = [];
		e.delim !== "." && t.push(wn(e.delim, e.mode));
		var n = new Y("mo", t);
...
K({
	...
	handler: (t, n) => {
		...
		if (r && typeof r != "string") throw new e("\\current@color set to non-string in \\right");
		return {
			type: "leftright-right",
			mode: t.parser.mode,
			delim: Yr(n[0], t).text,
	...
	htmlBuilder: (e, t) => {
		Xr(e);
		for (var n = fn(e.body, t, !0, ["mopen", "mclose"]), r = 0, i = 0, a = !1, o = 0; o < n.length; o++) {
			var s = n[o];
			Jr(s) ? a = !0 : (r = Math.max(n[o].height, r), i = Math.max(n[o].depth, i));
		}
		r *= t.sizeMultiplier, i *= t.sizeMultiplier;
		var c = e.left === "." ? _n(t, ["mopen"]) : Gr(e.left, r, i, t, e.mode, ["mopen"]);
		if (n.unshift(c), a) for (var l = 1; l < n.length; l++) {
			var u = n[l];
			if (Jr(u)) {
				var d = u.isMiddle;
				n[l] = Gr(d.delim, r, i, d.options, e.mode, []);
			}
		}
		var f;
		if (e.right === ".") f = _n(t, ["mclose"]);
		else {
			var p = e.rightColor ? t.withColor(e.rightColor) : t;
			f = Gr(e.right, r, i, p, e.mode, ["mclose"]);
		}
		return n.push(f), U(["minner"], n, t);
	},
	mathmlBuilder: (e, t) => {
		Xr(e);
		var n = kn(e.body, t);
		if (e.left !== ".") {
			var r = new Y("mo", [wn(e.left, e.mode)]);
			r.setAttribute("fence", "true"), n.unshift(r);
		}
		if (e.right !== ".") {
			var i = new Y("mo", [wn(e.right, e.mode)]);
	...
	handler: (t, n) => {
		var r = Yr(n[0], t);
		if (!t.parser.leftrightDepth) throw new e("\\middle without preceding \\left", r);
		return {
			type: "middle",
			mode: t.parser.mode,
			delim: r.text
	...
	htmlBuilder: (e, t) => {
		var n;
		return e.delim === "." ? n = _n(t, []) : (n = Rr(e.delim, 1, t, e.mode, []), n.isMiddle = {
			delim: e.delim,
			options: t
		}), n;
	},
	mathmlBuilder: (e, t) => {
		var n = new Y("mo", [e.delim === "\\vert" || e.delim === "|" ? wn("|", "text") : wn(e.delim, e.mode)]);
		return n.setAttribute("fence", "true"), n.setAttribute("lspace", "0.05em"), n.setAttribute("rspace", "0.05em"), n;
	}
});
var Zr = (e, t) => {
	var n = Gt(J(e.body, t), t), r = e.label.slice(1), i = t.sizeMultiplier, a, o, s = c(e.body);
	if (r === "sout") a = U(["stretchy", "sout"]), a.height = t.fontMetrics().defaultRuleThickness / i, o = -.5 * t.fontMetrics().xHeight;
	else if (r === "phase") {
		var l = D({
			number: .6,
			unit: "pt"
		...
		n.style.paddingLeft = O(f / 2 + l);
		var p = Math.floor(1e3 * f * i);
		a = Vt(["hide-tail"], [new Re([new ze("phase", ge(p))], {
			width: "400em",
			height: O(p / 1e3),
			viewBox: "0 0 400000 " + p,
			preserveAspectRatio: "xMinYMin slice"
		})], t), a.style.height = O(f), o = n.depth + l + u;
	} else {
		/cancel/.test(r) ? s || n.classes.push("cancel-pad") : r === "angl" ? n.classes.push("anglpad") : n.classes.push("boxpad");
		var m, h, g = 0;
		/box/.test(r) ? (g = Math.max(t.fontMetrics().fboxrule, t.minRuleThickness), m = t.fontMetrics().fboxsep + (r === "colorbox" ? 0 : g), h = m) : r === "angl" ? (g = Math.max(t.fontMetrics().defaultRuleThickness, t.minRuleThickness), m = 4 * g, h = Math.max(0, .25 - n.depth)) : (m = s ? .2 : 0, h = m), a = Gn(n, r, m, h, t), /fbox|boxed|fcolorbox/.test(r) ? (a.style.borderStyle = "solid", a.style.borderWidth = O(g)) : r === "angl" && g !== .049 && (a.style.borderTopWidth = O(g), a.style.borderRightWidth = O(g)), o = n.depth + h, e.backgroundColor && (a.style.backgroundColor = e.backgroundColor, e.borderColor && (a.style.borderColor = e.borderColor));
	}
	var _;
	if (e.backgroundColor) _ = W({
		positionType: "individualShift",
		children: [{
			type: "elem",
			elem: a,
	...
	return /cancel/.test(r) && (_.height = n.height, _.depth = n.depth), /cancel/.test(r) && !s ? U(["mord", "cancel-lap"], [_], t) : U(["mord"], [_], t);
}, Qr = (e, t) => {
	var n, r = new Y(e.label.includes("colorbox") ? "mpadded" : "menclose", [Z(e.body, t)]);
	switch (e.label) {
		case "\\cancel":
		...
		case "\\colorbox":
			if (n = t.fontMetrics().fboxsep * t.fontMetrics().ptPerEm, r.setAttribute("width", "+" + 2 * n + "pt"), r.setAttribute("height", "+" + 2 * n + "pt"), r.setAttribute("lspace", n + "pt"), r.setAttribute("voffset", n + "pt"), e.label === "\\fcolorbox") {
				...
				r.setAttribute("style", "border: " + O(i) + " solid " + e.borderColor);
			}
			break;
		case "\\xcancel":
...
var ai = (t) => {
	if (!t.parser.settings.displayMode) throw new e("{" + t.envName + "} can be used only in display mode.");
}, oi = new Set(["gather", "gather*"]);
function si(e) {
	if (!e.includes("ed")) return !e.includes("*");
}
function ci(t, n, r) {
	var { hskipBeforeAndAfter: i, addJot: a, cols: o, arraystretch: s, colSeparationType: c, autoTag: l, singleRow: u, emptySingleRow: d, maxNumCols: f, leqno: p } = n;
	if (t.gullet.beginGroup(), u || t.gullet.macros.set("\\cr", "\\\\\\relax"), !s) {
		var m = t.gullet.expandMacroAsText("\\arraystretch");
		if (m == null) s = 1;
		else if (s = parseFloat(m), !s || s < 0) throw new e("Invalid \\arraystretch: " + m);
	}
	t.gullet.beginGroup();
	...
	function x() {
		y && (t.gullet.macros.get("\\df@tag") ? (y.push(t.subparse([new ri("\\df@tag")])), t.gullet.macros.set("\\df@tag", void 0, !0)) : y.push(!!l && t.gullet.macros.get("\\@eqnsw") === "1"));
	}
	for (b(), v.push(ii(t));;) {
		var S = t.parseExpression(!1, u ? "\\end" : "\\\\");
		...
		if (w === "&") {
			if (f && h.length === f) {
				if (u || c) throw new e("Too many tab characters: &", t.nextToken);
			...
			t.consume();
			var ee = void 0;
			t.gullet.future().text !== " " && (ee = t.parseSizeGroup(!0)), _.push(ee ? ee.value : null), x(), v.push(ii(t)), h = [], g.push(h), b();
		} else throw new e("Expected & or \\\\ or \\cr or \\end", t.nextToken);
	}
	return t.gullet.endGroup(), t.gullet.endGroup(), {
		type: "array",
		mode: t.mode,
...
var ui = function(t, n) {
	var r, i, a = t.body.length, o = t.hLinesBeforeRow, s = 0, c = Array(a), l = [], u = Math.max(n.fontMetrics().arrayRuleWidth, n.minRuleThickness), d = 1 / n.fontMetrics().ptPerEm, f = 5 * d;
	t.colSeparationType && t.colSeparationType === "small" && (f = .2778 * (n.havingStyle(T.SCRIPT).sizeMultiplier / n.sizeMultiplier));
	var p = t.colSeparationType === "CD" ? D({
		number: 3,
		unit: "ex"
	}, n) : 12 * d, m = 3 * d, h = t.arraystretch * p, g = .7 * h, _ = .3 * h, v = 0;
	function y(e) {
	...
	for (y(o[0]), r = 0; r < t.body.length; ++r) {
		...
		for (i = 0; i < b.length; ++i) {
			var w = J(b[i], n);
			S < w.depth && (S = w.depth), x < w.height && (x = w.height), C.cells[i] = w;
		}
		var ee = t.rowGaps[r], te = 0;
		ee && (te = D(ee, n), te > 0 && (te += _, S < te && (S = te), te = 0)), t.addJot && r < t.body.length - 1 && (S += m), C.height = x, C.depth = S, v += x, C.pos = v, v += S + te, c[r] = C, y(o[r + 1]);
	}
	var ne = v / 2 + n.fontMetrics().axisHeight, re = t.cols || [], ie = [], ae, oe, se = [];
	if (t.tags && t.tags.some((e) => e)) for (r = 0; r < a; ++r) {
		var ce = c[r], le = ce.pos - ne, E = t.tags[r], ue = void 0;
		ue = E === !0 ? U(["eqn-num"], [], n) : E === !1 ? U([], [], n) : U([], fn(E, n, !0), n), ue.depth = ce.depth, ue.height = ce.height, se.push({
			type: "elem",
			elem: ue,
			shift: le
		});
	}
	for (i = 0, oe = 0; i < s || oe < re.length; ++i, ++oe) {
		for (var de = re[oe], fe = !0; (pe = de)?.type === "separator";) {
			var pe;
			if (fe || (ae = U(["arraycolsep"], []), ae.style.width = O(n.fontMetrics().doubleRuleSep), ie.push(ae)), de.separator === "|" || de.separator === ":") {
				var me = de.separator === "|" ? "solid" : "dashed", he = U(["vertical-separator"], [], n);
				he.style.height = O(v), he.style.borderRightWidth = O(u), he.style.borderRightStyle = me, he.style.margin = "0 " + O(-u / 2);
				var ge = v - ne;
				ge && (he.style.verticalAlign = O(-ge)), ie.push(he);
			} else throw new e("Invalid separator type: " + de.separator);
			oe++, de = re[oe], fe = !1;
		}
		if (!(i >= s)) {
			var _e = void 0;
			(i > 0 || t.hskipBeforeAndAfter) && (_e = de?.pregap ?? f, _e !== 0 && (ae = U(["arraycolsep"], []), ae.style.width = O(_e), ie.push(ae)));
			var ve = [];
			for (r = 0; r < a; ++r) {
				var ye = c[r], be = ye.cells[i];
				if (be) {
					var xe = ye.pos - ne;
					be.depth = ye.depth, be.height = ye.height, ve.push({
						type: "elem",
						elem: be,
						shift: xe
					});
			...
			var Se = W({
				positionType: "individualShift",
				children: ve
			}), Ce = U(["col-align-" + (de?.align || "c")], [Se]);
			ie.push(Ce), (i < s - 1 || t.hskipBeforeAndAfter) && (_e = de?.postgap ?? f, _e !== 0 && (ae = U(["arraycolsep"], []), ae.style.width = O(_e), ie.push(ae)));
		}
	}
	var we = U(["mtable"], ie);
	if (l.length > 0) {
		for (var Te = Ht("hline", n, u), Ee = Ht("hdashline", n, u), De = [{
			type: "elem",
			elem: we,
			shift: 0
		}]; l.length > 0;) {
			var Oe = l.pop(), ke = Oe.pos - ne;
			Oe.isDashed ? De.push({
				type: "elem",
				elem: Ee,
				shift: ke
	...
	if (se.length === 0) return U(["mord"], [we], n);
	var Ae = U(["tag"], [W({
		positionType: "individualShift",
		children: se
	})], n);
	...
	for (var n = [], r = new Y("mtd", [], ["mtr-glue"]), i = new Y("mtd", [], ["mml-eqn-num"]), a = 0; a < e.body.length; a++) {
		for (var o = e.body[a], s = [], c = 0; c < o.length; c++) s.push(new Y("mtd", [Z(o[c], t)]));
	...
	if (e.cols && e.cols.length > 0) {
		...
		for (var v = g; v < _; v++) {
			var y = p[v];
			y.type === "align" ? (f += di[y.align], h && (m += "none "), h = !0) : y.type === "separator" && (h &&= (m += y.separator === "|" ? "solid " : "dashed ", !1));
		}
	...
	for (var ee = 1; ee < w.length - 1; ee++) C += w[ee].length === 0 ? "none " : w[ee][0] ? "dashed " : "solid ";
	...
	t.envName.includes("ed") || ai(t);
	var r = [], i = t.envName.includes("at") ? "alignat" : "align", a = t.envName === "split", o = ci(t.parser, {
		cols: r,
		addJot: !0,
	...
	if (n[0] && n[0].type === "ordgroup") {
		for (var u = "", d = 0; d < n[0].body.length; d++) {
			var f = Q(n[0].body[d], "textord");
			u += f.text;
		}
		s = Number(u), c = s * 2;
	}
	...
	o.body.forEach(function(t) {
		for (var n = 1; n < t.length; n += 2) Q(Q(t[n], "styling").body[0], "ordgroup").body.unshift(l);
		if (p) c < t.length && (c = t.length);
		else {
			var r = t.length / 2;
			if (s < r) throw new e("Too many math in a row: " + ("expected " + s + ", but got " + r), t[0]);
		}
	});
	for (var m = 0; m < c; ++m) {
		var h = "r", g = 0;
		m % 2 == 1 ? h = "l" : m > 0 && p && (g = 1), r[m] = {
			type: "align",
			align: h,
			pregap: g,
			postgap: 0
	...
	return o.colSeparationType = p ? "align" : "alignat", o;
};
ei({
	type: "array",
	names: ["array", "darray"],
	props: { numArgs: 1 },
	handler(t, n) {
		var r = (Xn(n[0]) ? [n[0]] : Q(n[0], "ordgroup").body).map(function(t) {
			var n = Yn(t).text;
			...
			throw new e("Unknown column alignment: " + n, t);
		}), i = {
			cols: r,
			hskipBeforeAndAfter: !0,
			maxNumCols: r.length
		};
		return ci(t.parser, i, li(t.envName));
	},
	htmlBuilder: ui,
	mathmlBuilder: fi
}), ei({
	...
	handler(t) {
		...
		if (t.envName.charAt(t.envName.length - 1) === "*") {
			...
			if (a.consumeSpaces(), a.fetch().text === "[") {
				if (a.consume(), a.consumeSpaces(), r = a.fetch().text, !"lcr".includes(r)) throw new e("Expected l or c or r", a.nextToken);
				a.consume(), a.consumeSpaces(), a.expect("]"), a.consume(), i.cols = [{
					type: "align",
					align: r
				}];
			}
		}
		var o = ci(t.parser, i, li(t.envName)), s = Math.max(0, ...o.body.map((e) => e.length));
		return o.cols = Array(s).fill({
			type: "align",
			align: r
		}), n ? {
			type: "leftright",
	...
	props: { numArgs: 0 },
	handler(e) {
		var t = ci(e.parser, { arraystretch: .5 }, "script");
	...
	handler(t, n) {
		...
		if (r.length > 1) throw new e("{subarray} can contain only one column");
		var i = {
			cols: r,
			hskipBeforeAndAfter: !1,
			arraystretch: .5
		}, a = ci(t.parser, i, "script");
		if (a.body.length > 0 && a.body[0].length > 1) throw new e("{subarray} can contain only one column");
		return a;
	},
	htmlBuilder: ui,
	mathmlBuilder: fi
	...
	handler(t, n) {
		throw new e(t.funcName + " valid only within array environment");
	}
});
var mi = $r;
K({
	...
	handler(t, n) {
		var { parser: r, funcName: i } = t, a = n[0];
		if (a.type !== "ordgroup") throw new e("Invalid environment name", a);
		for (var o = "", s = 0; s < a.body.length; ++s) o += Q(a.body[s], "textord").text;
		if (i === "\\begin") {
			if (!mi.hasOwnProperty(o)) throw new e("No such environment: " + o, a);
			var c = mi[o], { args: l, optArgs: u } = r.parseArguments("\\begin{" + o + "}", c), d = {
				mode: r.mode,
				envName: o,
				parser: r
			}, f = c.handler(d, l, u);
			r.expect("\\end", !1);
			var p = r.nextToken, m = Q(r.parseFunction(), "environment");
			if (m.name !== o) throw new e("Mismatch: \\begin{" + o + "} matched by \\end{" + m.name + "}", p);
			return f;
		}
		return {
			type: "environment",
...
K({
	...
	handler: (e, t) => {
		var { parser: n, funcName: r } = e, i = sn(t[0]), a = r;
		return a in _i && (a = _i[a]), {
			type: "font",
			mode: n.mode,
			font: a.slice(1),
			body: i
...
var vi = (e, t) => {
	...
	e.hasBarLine ? (e.barSize ? (d = D(e.barSize, t), u = Ht("frac-line", t, d)) : u = Ht("frac-line", t), d = u.height, f = u.height) : (u = null, d = 0, f = t.fontMetrics().defaultRuleThickness);
	var p, m, h;
	n.size === T.DISPLAY.size ? (p = t.fontMetrics().num1, m = d > 0 ? 3 * f : 7 * f, h = t.fontMetrics().denom1) : (d > 0 ? (p = t.fontMetrics().num2, m = f) : (p = t.fontMetrics().num3, m = 3 * f), h = t.fontMetrics().denom2);
	var g;
	if (u) {
	...
	var b = n.size === T.DISPLAY.size ? t.fontMetrics().delim1 : n.size === T.SCRIPTSCRIPT.size ? t.havingStyle(T.SCRIPT).fontMetrics().delim2 : t.fontMetrics().delim2, x = e.leftDelim == null ? _n(t, ["mopen"]) : Wr(e.leftDelim, b, !0, t.havingStyle(n), e.mode, ["mopen"]), S = e.continued ? U([]) : e.rightDelim == null ? _n(t, ["mclose"]) : Wr(e.rightDelim, b, !0, t.havingStyle(n), e.mode, ["mclose"]);
	return U(["mord"].concat(a.sizingClasses(t)), [
		x,
		U(["mfrac"], [g]),
		S
	], t);
}, yi = (e, t) => {
	var n = new Y("mfrac", [Z(e.numer, t), Z(e.denom, t)]);
	...
	if (e.leftDelim != null || e.rightDelim != null) {
		...
		if (i.push(n), e.rightDelim != null) {
			var o = new Y("mo", [new X(e.rightDelim.replace("\\", ""))]);
...
K({
	...
	handler: (e, t) => {
		...
		return l || r.startsWith("\\d") ? u = "display" : r.startsWith("\\t") && (u = "text"), bi({
			type: "genfrac",
			mode: n.mode,
			numer: i,
			denom: a,
...
K({
	...
	handler(e, t) {
		var { parser: n } = e, r = t[4], i = t[5], a = sn(t[0]), o = a.type === "atom" && a.family === "open" ? Si(a.text) : null, s = sn(t[1]), c = s.type === "atom" && s.family === "close" ? Si(s.text) : null, l = Q(t[2], "size"), u, d = null;
		...
		} else p = Q(p, "textord"), f = xi[Number(p.text)];
		return bi({
			type: "genfrac",
			mode: n.mode,
			numer: r,
...
var Ci = (e, t) => {
	var n = t.style, r, i;
	e.type === "supsub" ? (r = e.sup ? J(e.sup, t.havingStyle(n.sup()), t) : J(e.sub, t.havingStyle(n.sub()), t), i = Q(e.base, "horizBrace")) : i = Q(e, "horizBrace");
	var a = J(i.base, t.havingBaseStyle(T.DISPLAY)), o = Wn(i, t), s = i.isOver ? W({
		positionType: "firstBaseline",
		children: [
			{
				type: "elem",
	...
	if (r) {
		var c = U(["minner", i.isOver ? "mover" : "munder"], [s], t);
		s = i.isOver ? W({
			positionType: "firstBaseline",
			children: [
				{
	...
	return U(["minner", i.isOver ? "mover" : "munder"], [s], t);
};
K({
	type: "horizBrace",
	names: [
	...
	mathmlBuilder: (e, t) => {
		var n = Vn(e.label);
		return new Y(e.isOver ? "mover" : "munder", [Z(e.base, t), n]);
	}
}), K({
	type: "href",
	names: ["\\href"],
	...
	htmlBuilder(e, t) {
		return Wt(fn(e.body, t.withFont(""), !1));
	},
	mathmlBuilder(e, t) {
		return new Y("mrow", kn(e.body, t.withFont("")));
	}
}), K({
	type: "html",
	names: [
	...
	handler: (t, n) => {
		var { parser: r, funcName: i, token: a } = t, o = Q(n[0], "raw").string, s = n[1];
		...
		switch (i) {
			...
			case "\\htmlData":
				for (var u = o.split(","), d = 0; d < u.length; d++) {
					...
					if (p < 0) throw new e("\\htmlData key/value '" + f + "' missing equals sign");
	...
	htmlBuilder: (e, t) => {
		var n = fn(e.body, t, !1), r = ["enclosing"];
	...
	htmlBuilder: (e, t) => Wt(fn(e.html, t, !1)),
	mathmlBuilder: (e, t) => An(e.mathml, t)
});
var wi = function(t) {
	...
	if (!n) throw new e("Invalid size: '" + t + "' in \\includegraphics");
	var r = {
		number: +(n[1] + n[2]),
		unit: n[3]
	};
	if (!Ee(r)) throw new e("Invalid unit: '" + r.unit + "' in \\includegraphics.");
	return r;
};
K({
	...
	handler: (t, n, r) => {
		...
		if (r[0]) for (var l = Q(r[0], "raw").string.split(","), u = 0; u < l.length; u++) {
			var d = l[u].split("=");
			if (d.length === 2) {
				var f = d[1].trim();
				switch (d[0].trim()) {
					...
					case "totalheight":
						s = wi(f);
						break;
					default: throw new e("Invalid key: '" + d[0] + "' in \\includegraphics.");
				}
			}
		}
		var p = Q(n[0], "url").url;
		return c === "" && (c = p, c = c.replace(/^.*[\\/]/, ""), c = c.substring(0, c.lastIndexOf("."))), i.settings.isTrusted({
	...
	htmlBuilder: (e, t) => {
		var n = D(e.height, t), r = 0;
		e.totalheight.number > 0 && (r = D(e.totalheight, t) - n);
		var i = 0;
		e.width.number > 0 && (i = D(e.width, t));
		var a = { height: O(n + r) };
		i > 0 && (a.width = O(i)), r > 0 && (a.verticalAlign = O(-r));
		var o = new Fe(e.src, e.alt, a);
		return o.height = n, o.depth = r, o;
	},
	mathmlBuilder: (e, t) => {
		var n = new Y("mglyph", []);
		n.setAttribute("alt", e.alt);
		var r = D(e.height, t), i = 0;
		if (e.totalheight.number > 0 && (i = D(e.totalheight, t) - r, n.setAttribute("valign", O(-i))), n.setAttribute("height", O(r + i)), e.width.number > 0) {
			var a = D(e.width, t);
			n.setAttribute("width", O(a));
		}
	...
	htmlBuilder(e, t) {
		return qt(e.dimension, t);
	},
	mathmlBuilder(e, t) {
		return new xn(D(e.dimension, t));
	}
}), K({
	type: "lap",
	names: [
	...
	htmlBuilder: (e, t) => {
		var n;
		e.alignment === "clap" ? (n = U([], [J(e.body, t)]), n = U(["inner"], [n], t)) : n = U(["inner"], [J(e.body, t)]);
		var r = U(["fix"], []), i = U([e.alignment], [n, r], t), a = U(["strut"]);
		return a.style.height = O(i.height + i.depth), i.depth && (a.style.verticalAlign = O(-i.depth)), i.children.unshift(a), i = U(["thinbox"], [i], t), U(["mord", "vbox"], [i], t);
	},
	mathmlBuilder: (e, t) => {
		var n = new Y("mpadded", [Z(e.body, t)]);
		if (e.alignment !== "rlap") {
	...
	handler(t, n) {
		throw new e("Mismatched " + t.funcName);
	}
});
var Ti = (e, t) => {
	switch (t.style.size) {
		case T.DISPLAY.size: return e.display;
		case T.TEXT.size: return e.text;
		case T.SCRIPT.size: return e.script;
		case T.SCRIPTSCRIPT.size: return e.scriptscript;
...
K({
	...
	htmlBuilder: (e, t) => Wt(fn(Ti(e, t), t, !1)),
	mathmlBuilder: (e, t) => An(Ti(e, t), t)
});
var Ei = (e, t, n, r, i, a, o) => {
	e = U([], [e]);
	var s = n && c(n), l, u;
	if (t) {
		var d = J(t, r.havingStyle(i.sup()), r);
		u = {
			elem: d,
	...
	if (n) {
		var f = J(n, r.havingStyle(i.sub()), r);
		l = {
			elem: f,
	...
	if (l && a !== 0 && !s) {
		var h = U(["mspace"], [], r);
		h.style.marginRight = O(a), m.unshift(h);
	}
	return U(["mop", "op-limits"], m, r);
}, Di = new Set(["\\smallint"]), Oi = (e, t) => {
	var n, r, i = !1, a;
	e.type === "supsub" ? (n = e.sup, r = e.sub, a = Q(e.base, "op"), i = !0) : a = Q(e, "op");
	var o = t.style, s = !1;
	o.size === T.DISPLAY.size && a.symbol && !Di.has(a.name) && (s = !0);
	var c, l;
	if (a.symbol) {
		var u = s ? "Size2-Regular" : "Size1-Regular", d = "";
		if ((a.name === "\\oiint" || a.name === "\\oiiint") && (d = a.name.slice(1), a.name = d === "oiint" ? "\\iint" : "\\iiint"), c = Pt(a.name, u, "math", t, [
			"mop",
			"op-symbol",
			s ? "large-op" : "small-op"
		]), l = c.italic, d.length > 0) {
			var f = Zt(d + "Size" + (s ? "2" : "1"), t);
			c = W({
				positionType: "individualShift",
				children: [{
					type: "elem",
		...
		var p = fn(a.body, t, !0);
		p.length === 1 && p[0] instanceof Le ? (c = p[0], c.classes[0] = "mop") : c = U(["mop"], p, t);
	} else {
		for (var m = [], h = 1; h < a.name.length; h++) m.push(Ft(a.name[h], a.mode, t));
		c = U(["mop"], m, t);
	}
	var g = 0, _ = 0;
	return (c instanceof Le || a.name === "\\oiint" || a.name === "\\oiiint") && !a.suppressBaseShift && (g = (c.height - c.depth) / 2 - t.fontMetrics().axisHeight, _ = c.italic ?? 0), i ? Ei(c, n, r, t, o, _, g) : (g && (c.style.position = "relative", c.style.top = O(g)), c);
}, ki = (e, t) => {
	var n;
	if (e.symbol) n = new Y("mo", [wn(e.name, e.mode)]), Di.has(e.name) && n.setAttribute("largeop", "false");
	else if (e.body) n = new Y("mo", kn(e.body, t));
	else {
		n = new Y("mi", [new X(e.name.slice(1))]);
		var r = new Y("mo", [wn("⁡", "text")]);
		n = e.parentIsSupSub ? new Y("mrow", [n, r]) : bn([n, r]);
	}
	return n;
}, Ai = {
	"∏": "\\prod",
...
var Mi = (e, t) => {
	...
	if (a.body.length > 0) {
		for (var s = fn(a.body.map((e) => {
			...
			var l = s[c];
			l instanceof Le && (l.text = l.text.replace(/\u2212/, "-").replace(/\u2217/, "*"));
		}
		o = U(["mop"], s, t);
	} else o = U(["mop"], [], t);
	return i ? Ei(o, n, r, t, t.style, 0, 0) : o;
};
K({
	type: "operatorname",
	...
	htmlBuilder: Mi,
	mathmlBuilder: (e, t) => {
		for (var n = kn(e.body, t.withFont("mathrm")), r = !0, i = 0; i < n.length; i++) {
			var a = n[i];
			if (!(a instanceof xn)) if (a instanceof Y) switch (a.type) {
				case "mi":
				case "mn":
				case "mspace":
				case "mtext": break;
				case "mo":
					var o = a.children[0];
					a.children.length === 1 && o instanceof X ? o.text = o.text.replace(/\u2212/, "-").replace(/\u2217/, "*") : r = !1;
					break;
				default: r = !1;
			}
			else r = !1;
		}
		r && (n = [new X(n.map((e) => e.toText()).join(""))]);
		var s = new Y("mi", n);
		s.setAttribute("mathvariant", "normal");
		var c = new Y("mo", [wn("⁡", "text")]);
		return e.parentIsSupSub ? new Y("mrow", [s, c]) : bn([s, c]);
	}
}), $("\\operatorname", "\\@ifstar\\operatornamewithlimits\\operatorname@"), on({
	type: "ordgroup",
	htmlBuilder(e, t) {
		return e.semisimple ? Wt(fn(e.body, t, !1)) : U(["mord"], fn(e.body, t, !0), t);
	},
	mathmlBuilder(e, t) {
		return An(e.body, t, !0);
	}
}), K({
	type: "overline",
	names: ["\\overline"],
	...
	htmlBuilder(e, t) {
		var n = J(e.body, t.havingCrampedStyle()), r = Ht("overline-line", t), i = t.fontMetrics().defaultRuleThickness;
		return U(["mord", "overline"], [W({
			positionType: "firstBaseline",
			children: [
				{
					type: "elem",
	...
	mathmlBuilder(e, t) {
		var n = new Y("mo", [new X("‾")]);
		n.setAttribute("stretchy", "true");
		var r = new Y("mover", [Z(e.body, t), n]);
		return r.setAttribute("accent", "true"), r;
	}
}), K({
	type: "phantom",
	...
	htmlBuilder: (e, t) => Wt(fn(e.body, t.withPhantom(), !1)),
	mathmlBuilder: (e, t) => new Y("mphantom", kn(e.body, t))
}), $("\\hphantom", "\\smash{\\phantom{#1}}"), K({
	type: "vphantom",
	names: ["\\vphantom"],
	props: {
		numArgs: 1,
	...
	htmlBuilder: (e, t) => U(["mord", "rlap"], [U(["inner"], [J(e.body, t.withPhantom())]), U(["fix"], [])], t),
	mathmlBuilder: (e, t) => {
		var n = new Y("mpadded", [new Y("mphantom", kn(q(e.body), t))]);
		return n.setAttribute("width", "0px"), n;
	}
}), K({
	type: "raisebox",
	...
	mathmlBuilder(e, t) {
		var n = new Y("mpadded", [Z(e.body, t)]), r = e.dy.number + e.dy.unit;
	...
	htmlBuilder(e, t) {
		var n = U(["mord", "rule"], [], t), r = D(e.width, t), i = D(e.height, t), a = e.shift ? D(e.shift, t) : 0;
		return n.style.borderRightWidth = O(r), n.style.borderTopWidth = O(i), n.style.bottom = O(a), n.width = r, n.height = i + a, n.depth = -a, n.maxFontSize = i * 1.125 * t.sizeMultiplier, n;
	},
	mathmlBuilder(e, t) {
		var n = D(e.width, t), r = D(e.height, t), i = e.shift ? D(e.shift, t) : 0, a = t.color && t.getColor() || "black", o = new Y("mspace");
		o.setAttribute("mathbackground", a), o.setAttribute("width", O(n)), o.setAttribute("height", O(r));
		var s = new Y("mpadded", [o]);
		return i >= 0 ? s.setAttribute("height", O(i)) : (s.setAttribute("height", O(i)), s.setAttribute("depth", O(-i))), s.setAttribute("voffset", O(i)), s;
	}
});
function Ni(e, t, n) {
	for (var r = fn(e, t, !1), i = t.sizeMultiplier / n.sizeMultiplier, a = 0; a < r.length; a++) {
...
K({
	...
	htmlBuilder: (e, t) => {
		...
		return Ni(e.body, n, t);
	},
	mathmlBuilder: (e, t) => {
		var n = t.havingSize(e.size), r = new Y("mstyle", kn(e.body, n));
		return r.setAttribute("mathsize", O(n.sizeMultiplier)), r;
	}
}), K({
	type: "smash",
	names: ["\\smash"],
	...
	htmlBuilder: (e, t) => {
		...
		if (e.smashHeight && (n.height = 0), e.smashDepth && (n.depth = 0), e.smashHeight && e.smashDepth) return U(["mord", "smash"], [n], t);
	...
	htmlBuilder(e, t) {
		...
		if (e.index) {
			var f = t.havingStyle(T.SCRIPTSCRIPT), p = J(e.index, f, t);
			return U(["mord", "sqrt"], [U(["root"], [W({
				positionType: "shift",
		...
		} else return U(["mord", "sqrt"], [d], t);
	},
	mathmlBuilder(e, t) {
		var { body: n, index: r } = e;
		return r ? new Y("mroot", [Z(n, t), Z(r, t)]) : new Y("msqrt", [Z(n, t)]);
	}
});
var Fi = {
	display: T.DISPLAY,
...
K({
	...
	handler(e, t) {
		...
		if (!Ii(o)) throw Error("Unknown style: " + o);
		return {
			type: "styling",
			mode: i.mode,
			style: o,
	...
	htmlBuilder(e, t) {
		var n = Fi[e.style], r = t.havingStyle(n);
		return e.resetFont && (r = r.withFont("")), Ni(e.body, r, t);
	},
	mathmlBuilder(e, t) {
		var n = Fi[e.style], r = t.havingStyle(n);
		e.resetFont && (r = r.withFont(""));
		var i = new Y("mstyle", kn(e.body, r)), a = {
			display: ["0", "true"],
			text: ["0", "false"],
			script: ["1", "false"],
...
var Li = function(e, t) {
	var n = e.base;
	return n ? n.type === "op" ? n.limits && (t.style.size === T.DISPLAY.size || n.alwaysHandleSupSub) ? Oi : null : n.type === "operatorname" ? n.alwaysHandleSupSub && (t.style.size === T.DISPLAY.size || n.limits) ? Mi : null : n.type === "accent" ? c(n.base) ? Qn : null : n.type === "horizBrace" && !e.sub === n.isOver ? Ci : null : null;
};
on({
	type: "supsub",
	htmlBuilder(e, t) {
		var n = Li(e, t);
		if (n) return n(e, t);
		var { base: r, sup: i, sub: a } = e, o = J(r, t), s, l, u = t.fontMetrics(), d = 0, f = 0, p = r && c(r);
		if (i) {
			var m = t.havingStyle(t.style.sup());
			s = J(i, m, t), p || (d = o.height - m.fontMetrics().supDrop * m.sizeMultiplier / t.sizeMultiplier);
		}
		if (a) {
			var h = t.havingStyle(t.style.sub());
			l = J(a, h, t), p || (f = o.depth + h.fontMetrics().subDrop * h.sizeMultiplier / t.sizeMultiplier);
		}
		var g = t.style === T.DISPLAY ? u.sup1 : t.style.cramped ? u.sup3 : u.sup2, _ = t.sizeMultiplier, v = O(.5 / u.ptPerEm / _), y = null;
		if (l) {
			var b = e.base && e.base.type === "op" && e.base.name && (e.base.name === "\\oiint" || e.base.name === "\\oiiint");
			(o instanceof Le || b) && (y = O(-(o.italic ?? 0)));
		}
		var x;
		if (s && l) {
			d = Math.max(d, g, s.depth + .25 * u.xHeight), f = Math.max(f, u.sub2);
			var S = 4 * u.defaultRuleThickness;
			if (d - s.depth - (l.height - f) < S) {
				f = S - (d - s.depth) + l.height;
				var C = .8 * u.xHeight - (d - s.depth);
				C > 0 && (d += C, f -= C);
			}
			x = W({
				positionType: "individualShift",
		...
		} else if (l) f = Math.max(f, u.sub1, l.height - .8 * u.xHeight), x = W({
			positionType: "shift",
			positionData: f,
			children: [{
				type: "elem",
		...
		else if (s) d = Math.max(d, g, s.depth + .25 * u.xHeight), x = W({
			positionType: "shift",
			positionData: -d,
			children: [{
				type: "elem",
		...
		return U([gn(o, "right") || "mord"], [o, U(["msupsub"], [x])], t);
	},
	mathmlBuilder(e, t) {
		var n = !1, r, i;
		...
		var a = [Z(e.base, t)];
		e.sub && a.push(Z(e.sub, t)), e.sup && a.push(Z(e.sup, t));
		var o;
		if (n) o = r ? "mover" : "munder";
		else if (!e.sub) {
			var s = e.base;
			o = s && s.type === "op" && s.limits && (t.style === T.DISPLAY || s.alwaysHandleSupSub) || s && s.type === "operatorname" && s.alwaysHandleSupSub && (s.limits || t.style === T.DISPLAY) ? "mover" : "msup";
		} else if (e.sup) {
			var c = e.base;
			o = c && c.type === "op" && c.limits && t.style === T.DISPLAY || c && c.type === "operatorname" && c.alwaysHandleSupSub && (t.style === T.DISPLAY || c.limits) ? "munderover" : "msubsup";
		} else {
			var l = e.base;
			o = l && l.type === "op" && l.limits && (t.style === T.DISPLAY || l.alwaysHandleSupSub) || l && l.type === "operatorname" && l.alwaysHandleSupSub && (l.limits || t.style === T.DISPLAY) ? "munder" : "msub";
		}
		return new Y(o, a);
	}
}), on({
	type: "atom",
	htmlBuilder(e, t) {
		return Ft(e.text, e.mode, t, ["m" + e.family]);
	},
	mathmlBuilder(e, t) {
		var n = new Y("mo", [wn(e.text, e.mode)]);
		if (e.family === "bin") {
			var r = Dn(e, t);
...
on({
	type: "mathord",
	htmlBuilder(e, t) {
		return Lt(e, t, "mathord");
	},
	mathmlBuilder(e, t) {
		var n = new Y("mi", [wn(e.text, e.mode, t)]), r = Dn(e, t) || "italic";
		return r !== Ri[n.type] && n.setAttribute("mathvariant", r), n;
	}
}), on({
	type: "textord",
	htmlBuilder(e, t) {
		return Lt(e, t, "textord");
	},
	mathmlBuilder(e, t) {
		var n = wn(e.text, e.mode, t), r = Dn(e, t) || "normal", i = e.mode === "text" ? new Y("mtext", [n]) : /[0-9]/.test(e.text) ? new Y("mn", [n]) : e.text === "\\prime" ? new Y("mo", [n]) : new Y("mi", [n]);
		return r !== Ri[i.type] && i.setAttribute("mathvariant", r), i;
	}
});
var zi = {
	"\\nobreak": "nobreak",
...
on({
	type: "spacing",
	htmlBuilder(t, n) {
		if (Bi.hasOwnProperty(t.text)) {
			var r = Bi[t.text].className || "";
			if (t.mode === "text") {
				var i = Lt(t, n, "textord");
				return i.classes.push(r), i;
			} else return U(["mspace", r], [Ft(t.text, t.mode, n)], n);
		} else if (zi.hasOwnProperty(t.text)) return U(["mspace", zi[t.text]], [], n);
		else throw new e("Unknown type of space \"" + t.text + "\"");
	},
	mathmlBuilder(t, n) {
		var r;
		if (Bi.hasOwnProperty(t.text)) r = new Y("mtext", [new X("\xA0")]);
		else if (zi.hasOwnProperty(t.text)) return new Y("mspace");
		else throw new e("Unknown type of space \"" + t.text + "\"");
		return r;
	}
});
...
on({
	...
	mathmlBuilder(e, t) {
		var n = new Y("mtable", [new Y("mtr", [
			Vi(),
			new Y("mtd", [An(e.body, t)]),
			Vi(),
			new Y("mtd", [An(e.tag, t)])
		])]);
...
var Hi = {
	...
	var n = e.font;
	return n ? Hi[n] ? t.withTextFontFamily(Hi[n]) : Ui[n] ? t.withTextFontWeight(Ui[n]) : n === "\\emph" ? t.fontShape === "textit" ? t.withTextFontShape("textup") : t.withTextFontShape("textit") : t.withTextFontShape(Wi[n]) : t;
};
K({
	type: "text",
	names: [
	...
	htmlBuilder(e, t) {
		var n = Gi(e, t);
		return U(["mord", "text"], fn(e.body, n, !0), n);
	},
	mathmlBuilder(e, t) {
		var n = Gi(e, t);
		return An(e.body, n);
	...
	htmlBuilder(e, t) {
		var n = J(e.body, t), r = Ht("underline-line", t), i = t.fontMetrics().defaultRuleThickness;
		return U(["mord", "underline"], [W({
			positionType: "top",
			positionData: n.height,
			children: [
				{
	...
	mathmlBuilder(e, t) {
		var n = new Y("mo", [new X("‾")]);
		n.setAttribute("stretchy", "true");
		var r = new Y("munder", [Z(e.body, t), n]);
		return r.setAttribute("accentunder", "true"), r;
	}
}), K({
	type: "vcenter",
	...
	mathmlBuilder(e, t) {
		return new Y("mrow", [new Y("mpadded", [Z(e.body, t)], ["vcenter"])]);
	}
}), K({
	type: "verb",
	names: ["\\verb"],
	...
	htmlBuilder(e, t) {
		for (var n = Ki(e), r = [], i = t.havingStyle(t.style.text()), a = 0; a < n.length; a++) {
			var o = n[a];
			o === "~" && (o = "\\textasciitilde"), r.push(Pt(o, "Typewriter-Regular", e.mode, i, ["mord", "texttt"]));
		}
		return U(["mord", "text"].concat(i.sizingClasses(t)), zt(r), i);
	},
	mathmlBuilder(e, t) {
		var n = new Y("mtext", [new X(Ki(e))]);
		return n.setAttribute("mathvariant", "monospace"), n;
	}
});
var Ki = (e) => e.body.replace(/ /g, e.star ? "␣" : "\xA0"), qi = nn, Ji = "[ \r\n	]", Yi = "\\\\[a-zA-Z@]+", Xi = "\\\\[^\ud800-\udfff]", Zi = "(" + Yi + ")" + Ji + "*", Qi = "\\\\(\n|[ \r	]+\n?)[ \r	]*", $i = "[̀-ͯ]", ea = RegExp($i + "+$"), ta = "(" + Ji + "+)|" + (Qi + "|") + "([!-\\[\\]-‧‪-퟿豈-￿]" + ($i + "*") + "|[\ud800-\udbff][\udc00-\udfff]" + ($i + "*") + "|\\\\verb\\*([^]).*?\\4|\\\\verb([^*a-zA-Z]).*?\\5" + ("|" + Zi) + ("|" + Xi + ")"), na = class {
	constructor(e, t) {
		this.input = void 0, this.settings = void 0, this.tokenRegex = void 0, this.catcodes = void 0, this.input = e, this.settings = t, this.tokenRegex = new RegExp(ta, "g"), this.catcodes = {
			"%": 14,
			"~": 13
		};
	}
	...
	lex() {
		...
		if (n === t.length) return new ri("EOF", new ni(this, n, n));
		var r = this.tokenRegex.exec(t);
		if (r === null || r.index !== n) throw new e("Unexpected character: '" + t[n] + "'", new ri(t[n], new ni(this, n, n + 1)));
		var i = r[6] || r[3] || (r[2] ? "\\ " : " ");
		...
		return new ri(i, new ni(this, n, this.tokenRegex.lastIndex));
	}
}, ra = class {
	constructor(e, t) {
...
$("\\char", function(t) {
	var n = t.popToken(), r, i = 0;
	if (n.text === "'") r = 8, n = t.popToken();
	else if (n.text === "\"") r = 16, n = t.popToken();
	else if (n.text === "`") if (n = t.popToken(), n.text[0] === "\\") i = n.text.charCodeAt(1);
	else if (n.text === "EOF") throw new e("\\char` missing argument");
	else i = n.text.charCodeAt(0);
	else r = 10;
	if (r) {
		if (i = aa[n.text], i == null || i >= r) throw new e("Invalid base-" + r + " digit " + n.text);
		for (var a; (a = aa[t.future().text]) != null && a < r;) i *= r, i += a, t.popToken();
	}
	return "\\@char{" + i + "}";
});
var oa = (t, n, r, i) => {
	var a = t.consumeArg().tokens;
	if (a.length !== 1) throw new e("\\newcommand's first argument must be a macro name");
	var o = a[0].text, s = t.isDefined(o);
	if (s && !n) throw new e("\\newcommand{" + o + "} attempting to redefine " + (o + "; use \\renewcommand"));
	if (!s && !r) throw new e("\\renewcommand{" + o + "} when command " + o + " does not yet exist; use \\newcommand");
	var c = 0;
	if (a = t.consumeArg().tokens, a.length === 1 && a[0].text === "[") {
		for (var l = "", u = t.expandNextToken(); u.text !== "]" && u.text !== "EOF";) l += u.text, u = t.expandNextToken();
		if (!l.match(/^\s*[0-9]+\s*$/)) throw new e("Invalid number of arguments: " + l);
		c = parseInt(l), a = t.consumeArg().tokens;
	}
	return s && i || t.macros.set(o, {
		tokens: a,
		numArgs: c
	}), "";
};
$("\\newcommand", (e) => oa(e, !1, !0, !1)), $("\\renewcommand", (e) => oa(e, !0, !1, !1)), $("\\providecommand", (e) => oa(e, !0, !0, !0)), $("\\message", (e) => {
	...
	return console.log(t, e.macros.get(n), qi[n], k.math[n], k.text[n]), "";
...
$("\\dots", function(e) {
	...
	return n in sa ? t = sa[n] : (n.slice(0, 4) === "\\not" || n in k.math && ca.has(k.math[n].group)) && (t = "\\dotsb"), t;
});
var la = {
	")": !0,
	"]": !0,
...
$("\\dotso", function(e) {
	return e.future().text in la ? "\\ldots\\," : "\\ldots";
}), $("\\dotsc", function(e) {
	var t = e.future().text;
	return t in la && t !== "," ? "\\ldots\\," : "\\ldots";
}), $("\\cdots", function(e) {
	return e.future().text in la ? "\\@cdots\\," : "\\@cdots";
}), $("\\dotsb", "\\cdots"), $("\\dotsm", "\\cdots"), $("\\dotsi", "\\!\\cdots"), $("\\dotsx", "\\ldots\\,"), $("\\DOTSI", "\\relax"), $("\\DOTSB", "\\relax"), $("\\DOTSX", "\\relax"), $("\\tmspace", "\\TextOrMath{\\kern#1#3}{\\mskip#1#2}\\relax"), $("\\,", "\\tmspace+{3mu}{.1667em}"), $("\\thinspace", "\\,"), $("\\>", "\\mskip{4mu}"), $("\\:", "\\tmspace+{4mu}{.2222em}"), $("\\medspace", "\\:"), $("\\;", "\\tmspace+{5mu}{.2777em}"), $("\\thickspace", "\\;"), $("\\!", "\\tmspace-{3mu}{.1667em}"), $("\\negthinspace", "\\!"), $("\\negmedspace", "\\tmspace-{4mu}{.2222em}"), $("\\negthickspace", "\\tmspace-{5mu}{.277em}"), $("\\enspace", "\\kern.5em "), $("\\enskip", "\\hskip.5em\\relax"), $("\\quad", "\\hskip1em\\relax"), $("\\qquad", "\\hskip2em\\relax"), $("\\tag", "\\@ifstar\\tag@literal\\tag@paren"), $("\\tag@paren", "\\tag@literal{({#1})}"), $("\\tag@literal", (t) => {
	if (t.macros.get("\\df@tag")) throw new e("Multiple \\tag");
...
var fa = {
	...
	constructor(e, t, n) {
		this.settings = void 0, this.expansionCount = void 0, this.lexer = void 0, this.macros = void 0, this.stack = void 0, this.mode = void 0, this.settings = t, this.expansionCount = 0, this.feed(e), this.macros = new ra(ia, t.macros), this.mode = n, this.stack = [];
	}
	feed(e) {
	...
	scanArgument(e) {
		...
		return this.pushToken(new ri("EOF", n.loc)), this.pushTokens(r), new ri("", ni.range(t, n));
	}
	consumeSpaces() {
	...
	consumeArg(t) {
		...
		var i = this.future(), a, o = 0, s = 0;
		do {
			if (a = this.popToken(), n.push(a), a.text === "{") ++o;
			else if (a.text === "}") {
				if (--o, o === -1) throw new e("Extra }", a);
			} else if (a.text === "EOF") throw new e("Unexpected end of input in a macro argument, expected '" + (t && r ? t[s] : "}") + "'", a);
			if (t && r) if ((o === 0 || o === 1 && t[s] === "{") && a.text === t[s]) {
				if (++s, s === t.length) {
					n.splice(-s, s);
					break;
				}
	...
	consumeArgs(t, n) {
		if (n) {
			if (n.length !== t + 1) throw new e("The length of delimiters doesn't match the number of args!");
			for (var r = n[0], i = 0; i < r.length; i++) {
				var a = this.popToken();
				if (r[i] !== a.text) throw new e("Use of the macro doesn't match its definition", a);
			}
		}
		for (var o = [], s = 0; s < t; s++) o.push(this.consumeArg(n && n[s + 1]).tokens);
		return o;
	}
	countExpansion(t) {
		if (this.expansionCount += t, this.expansionCount > this.settings.maxExpand) throw new e("Too many expansions: infinite loop or need to increase maxExpand setting");
	}
	expandOnce(t) {
		var n = this.popToken(), r = n.text, i = n.noexpand ? null : this._getExpansion(r);
		if (i == null || t && i.unexpandable) {
			if (t && i == null && r[0] === "\\" && !this.isDefined(r)) throw new e("Undefined control sequence: " + r);
			return this.pushToken(n), !1;
		}
		this.countExpansion(1);
		var a = i.tokens, o = this.consumeArgs(i.numArgs, i.delimiters);
		if (i.numArgs) {
			a = a.slice();
			for (var s = a.length - 1; s >= 0; --s) {
				var c = a[s];
				if (c.text === "#") {
					if (s === 0) throw new e("Incomplete placeholder at end of macro body", c);
					if (c = a[--s], c.text === "#") a.splice(s + 1, 1);
					else if (/^[1-9]$/.test(c.text)) a.splice(s, 2, ...o[c.text - 1]);
					else throw new e("Not a valid argument number", c);
				}
			}
		}
	...
	expandMacro(e) {
		return this.macros.has(e) ? this.expandTokens([new ri(e)]) : void 0;
	}
	expandTokens(e) {
	...
	isDefined(e) {
		return this.macros.has(e) || qi.hasOwnProperty(e) || k.math.hasOwnProperty(e) || k.text.hasOwnProperty(e) || fa.hasOwnProperty(e);
	}
	isExpandable(e) {
		var t = this.macros.get(e);
		return t == null ? qi.hasOwnProperty(e) && !qi[e].primitive : typeof t == "string" || typeof t == "function" || !t.unexpandable;
	}
}, ma = /^[₊₋₌₍₎₀₁₂₃₄₅₆₇₈₉ₐₑₕᵢⱼₖₗₘₙₒₚᵣₛₜᵤᵥₓᵦᵧᵨᵩᵪ]/, ha = Object.freeze({
	"₊": "+",
	"₋": "-",
	"₌": "=",
	"₍": "(",
	...
	constructor(e, t) {
		this.mode = void 0, this.gullet = void 0, this.settings = void 0, this.leftrightDepth = void 0, this.nextToken = void 0, this.mode = "math", this.gullet = new pa(e, t, this.mode), this.settings = t, this.leftrightDepth = 0, this.nextToken = null;
	}
	expect(t, n) {
		if (n === void 0 && (n = !0), this.fetch().text !== t) throw new e("Expected '" + t + "', got '" + this.fetch().text + "'", this.fetch());
		n && this.consume();
	}
	consume() {
		this.nextToken = null;
	...
	subparse(e) {
		...
		this.consume(), this.gullet.pushToken(new ri("}")), this.gullet.pushTokens(e);
	...
	parseExpression(e, n) {
		for (var r = [];;) {
			...
			var i = this.fetch();
			if (t.endOfExpression.has(i.text) || n && i.text === n || e && qi[i.text] && qi[i.text].infix) break;
	...
	handleInfixNodes(t) {
		for (var n = -1, r, i = 0; i < t.length; i++) {
			var a = t[i];
			if (a.type === "infix") {
				if (n !== -1) throw new e("only one infix operator per group", a.token);
				n = i, r = a.replaceWith;
			}
		}
		if (n !== -1 && r) {
			var o, s, c = t.slice(0, n), l = t.slice(n + 1);
	...
	handleSupSubscript(t) {
		...
		do
			i = this.parseGroup(t);
		while (i?.type === "internal");
		if (!i) throw new e("Expected group after '" + r + "'", n);
		return i;
	}
	...
	parseAtom(t) {
		...
		for (var r, i;;) {
			...
			if (a.text === "\\limits" || a.text === "\\nolimits") {
				if (n && n.type === "op") n.limits = a.text === "\\limits", n.alwaysHandleSupSub = !0;
				else if (n && n.type === "operatorname") n.alwaysHandleSupSub && (n.limits = a.text === "\\limits");
				else throw new e("Limit controls must follow a math operator", a);
				this.consume();
			} else if (a.text === "^") {
				if (r) throw new e("Double superscript", a);
				r = this.handleSupSubscript("superscript");
			} else if (a.text === "_") {
				if (i) throw new e("Double subscript", a);
				...
				var c = ma.test(a.text), l = [];
				for (l.push(new ri(ha[a.text])), this.consume();;) {
					var u = this.fetch().text;
					if (!ha[u] || ma.test(u) !== c) break;
					l.unshift(new ri(ha[u])), this.consume();
				}
	...
	parseFunction(t, n) {
		var r = this.fetch(), i = r.text, a = qi[i];
		if (!a) return null;
		if (this.consume(), n && n !== "atom" && !a.allowedInArgument) throw new e("Got function '" + i + "' with no arguments" + (n ? " as " + n : ""), r);
		if (this.mode === "text" && !a.allowedInText) throw new e("Can't use function '" + i + "' in text mode", r);
		if (this.mode === "math" && a.allowedInMath === !1) throw new e("Can't use function '" + i + "' in math mode", r);
		var { args: o, optArgs: s } = this.parseArguments(i, a);
		return this.callFunction(i, o, s, r, t);
	}
	callFunction(t, n, r, i, a) {
		...
		if (s && s.handler) return s.handler(o, n, r);
		throw new e("No function handler for " + t);
	}
	parseArguments(t, n) {
		...
		for (var i = [], a = [], o = 0; o < r; o++) {
			var s = n.argTypes && n.argTypes[o], c = o < n.numOptionalArgs;
			("primitive" in n && n.primitive && s == null || n.type === "sqrt" && o === 1 && a[0] == null) && (s = "primitive");
			var l = this.parseGroupOfType("argument to '" + t + "'", s, c);
			if (c) a.push(l);
	...
	parseGroupOfType(t, n, r) {
		switch (n) {
			...
			case "primitive":
				if (r) throw new e("A primitive argument cannot be optional");
				var o = this.parseGroup(t);
				if (o == null) throw new e("Expected group as " + t, this.fetch());
				return o;
			case "original":
			case null:
			case void 0: return this.parseArgumentGroup(r);
			default: throw new e("Unknown group type as " + t, this.fetch());
		}
	}
	consumeSpaces() {
	...
	parseRegexGroup(t, n) {
		for (var r = this.fetch(), i = r, a = "", o; (o = this.fetch()).text !== "EOF" && t.test(a + o.text);) i = o, a += i.text, this.consume();
		if (a === "") throw new e("Invalid " + n + ": '" + r.text + "'", r);
		return r.range(i, a);
	}
	parseColorGroup(t) {
		...
		if (!r) throw new e("Invalid color: '" + n.text + "'", n);
		var i = r[0];
	...
	parseSizeGroup(t) {
		...
		if (!i) throw new e("Invalid size: '" + n.text + "'", n);
		var a = {
			number: +(i[1] + i[2]),
			unit: i[3]
		};
		if (!Ee(a)) throw new e("Invalid unit: '" + a.unit + "'", n);
		return {
			type: "size",
			mode: this.mode,
			value: a,
	...
	parseGroup(t, n) {
		...
		if (i === "{" || i === "\\begingroup") {
			...
			var s = this.parseExpression(!1, o), c = this.fetch();
			this.expect(o), this.gullet.endGroup(), a = {
				type: "ordgroup",
				mode: this.mode,
				loc: ni.range(r, c),
				body: s,
		...
		} else if (a = this.parseFunction(n, t) || this.parseSymbol(), a == null && i[0] === "\\" && !fa.hasOwnProperty(i)) {
			if (this.settings.throwOnError) throw new e("Undefined control sequence: " + i, r);
	...
	parseSymbol() {
		...
		if (/^\\verb[^a-zA-Z]/.test(n)) {
			...
			if (i && (r = r.slice(1)), r.length < 2 || r.charAt(0) !== r.slice(-1)) throw new e("\\verb assertion failed --\n                    please report what input caused this bug");
		...
		_a.hasOwnProperty(n[0]) && !k[this.mode][n[0]] && (this.settings.strict && this.mode === "math" && this.settings.reportNonstrict("unicodeTextInMathMode", "Accented Unicode text character \"" + n[0] + "\" used in math mode", t), n = _a[n[0]] + n.slice(1));
		var a = ea.exec(n);
		a && (n = n.substring(0, a.index), n === "i" ? n = "ı" : n === "j" && (n = "ȷ"));
		var o;
		if (k[this.mode][n]) {
			this.settings.strict && this.mode === "math" && ht.includes(n) && this.settings.reportNonstrict("unicodeTextInMathMode", "Latin-1/Unicode text character \"" + n[0] + "\" used in math mode", t);
			var s = k[this.mode][n].group, c = ni.range(t);
			o = Jn(s) ? {
				type: "atom",
				mode: this.mode,
				family: s,
		...
		} else if (n.charCodeAt(0) >= 128) this.settings.strict && (le(n.charCodeAt(0)) ? this.mode === "math" && this.settings.reportNonstrict("unicodeTextInMathMode", "Unicode text character \"" + n[0] + "\" used in math mode", t) : this.settings.reportNonstrict("unknownSymbol", "Unrecognized Unicode character \"" + n[0] + "\"" + (" (" + n.charCodeAt(0) + ")"), t)), o = {
			type: "textord",
			mode: "text",
			loc: ni.range(t),
			text: n
		...
		if (this.consume(), a) for (var l = 0; l < a[0].length; l++) {
			var u = a[0][l];
			if (!ga[u]) throw new e("Unknown accent ' " + u + "'", t);
			var d = ga[u][this.mode] || ga[u].text;
			if (!d) throw new e("Accent " + u + " unsupported in " + this.mode + " mode", t);
			o = {
				type: "accent",
				mode: this.mode,
				loc: ni.range(t),
...
var ya = function(t, n) {
	...
	if (delete r.gullet.macros.current["\\current@color"], delete r.gullet.macros.current["\\color"], r.gullet.macros.get("\\df@tag")) {
		if (!n.displayMode) throw new e("\\tag works only in display equations");
		i = [{
			type: "tag",
			mode: "text",
			body: i,
			tag: r.subparse([new ri("\\df@tag")])
		}];
	}
	return i;
}, ba = function(e, t, n) {
...
typeof document < "u" && document.compatMode !== "CSS1Compat" && (typeof console < "u" && console.warn("Warning: KaTeX doesn't work in quirks mode. Make sure your website has a suitable doctype."), ba = function() {
	throw new e("KaTeX doesn't work in quirks mode.");
});
var xa = function(e, t) {
	return wa(e, t).toMarkup();
}, Sa = function(e, t) {
	return ya(e, new m(t));
}, Ca = function(t, n, r) {
	if (r.throwOnError || !(t instanceof e)) throw t;
	var i = U(["katex-error"], [new Le(n)]);
	return i.setAttribute("title", t.toString()), i.setAttribute("style", "color:" + r.errorColor), i;
}, wa = function(e, t) {
	var n = new m(t);
	try {
		return Rn(ya(e, n), e, n);
	} catch (t) {
		return Ca(t, e, n);
	}
}, Ta = function(e, t) {
	...
	SETTINGS_SCHEMA: u,
	__parse: Sa,
	__renderToDomTree: wa,
	__renderToHTMLTree: Ta,
	__setFontMetrics: qe,
	__defineSymbol: A,
	__defineFunction: K,
	__defineMacro: $,
...
//#endregion
export { e as ParseError, u as SETTINGS_SCHEMA, K as __defineFunction, $ as __defineMacro, A as __defineSymbol, Da as __domTree, Sa as __parse, wa as __renderToDomTree, Ta as __renderToHTMLTree, qe as __setFontMetrics, Oa as default, ba as render, xa as renderToString, Ea as version };

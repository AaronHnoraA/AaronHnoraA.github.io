...
`:e}},t),this.rules=new x(this.options)}B.prototype={turndown:function(e){if(!G(e))throw TypeError(e+` is not a string, or an element/document/fragment node.`);if(e===``)return``;var t=V.call(this,new te(e,this.options));return H.call(this,t)},use:function(e){if(Array.isArray(e))for(var t=0;t<e.length;t++)this.use(e[t]);else if(typeof e==`function`)e(this);else throw TypeError(`plugin must be a Function or an Array of Functions`);return this},addRule:function(e,t){return this.rules.add(e,t),this},keep:function(e){return this.rules.keep(e),this},remove:function(e){return this.rules.remove(e),this},escape:function(e){return g(e)}};function V(e){var t=this;return z.call(e.childNodes,function(e,n){n=new P(n,t.options);var r=``;return n.nodeType===3?r=n.isCode?n.nodeValue:t.escape(n.nodeValue):n.nodeType===1&&(r=U.call(t,n)),W(e,r)},``)}function H(e){var t=this;return this.rules.forEach(function(n){typeof n.append==`function`&&(e=W(e,n.append(t.options)))}),e.replace(/^[\t\r\n]+/,``).replace(/[\t\r\n\s]+$/,``)}function U(e){var t=this.rules.forNode(e),n=V.call(this,e),r=e.flankingWhitespace;return(r.leading||r.trailing)&&(n=n.trim()),r.leading+t.replacement(n,e,this.options)+r.trailing}function W(e,t){var i=r(e),a=n(t),o=Math.max(e.length-i.length,t.length-a.length);return i+`

`.substring(0,o)+a}function G(e){return e!=null&&(typeof e==`string`||e.nodeType&&(e.nodeType===1||e.nodeType===9||e.nodeType===11))}var K=/highlight-(?:text|source)-([a-z0-9]+)/;function q(e){e.addRule(`highlightedCodeBlock`,{filter:function(e){var t=e.firstChild;return e.nodeName===`DIV`&&K.test(e.className)&&t&&t.nodeName===`PRE`},replacement:function(e,t,n){var r=((t.className||``).match(K)||[null,``])[1];return`

`+n.fence+r+`
`+t.firstChild.textContent+`
`+n.fence+`

`}})}function J(e){e.addRule(`strikethrough`,{filter:[`del`,`s`,`strike`],replacement:function(e){return`~`+e+`~`}})}var Y=Array.prototype.indexOf,X=Array.prototype.every,Z={};Z.tableCell={filter:[`th`,`td`],replacement:function(e,t){return $(e,t)}},Z.tableRow={filter:`tr`,replacement:function(e,t){var n=``,r={left:`:--`,right:`--:`,center:`:-:`};if(Q(t))for(var i=0;i<t.childNodes.length;i++){var a=`---`,o=(t.childNodes[i].getAttribute(`align`)||``).toLowerCase();o&&(a=r[o]||a),n+=$(a,t.childNodes[i])}return`
`+e+(n?`
`+n:``)}},Z.table={filter:function(e){return e.nodeName===`TABLE`&&Q(e.rows[0])},replacement:function(e){return e=e.replace(`
...
`}},Z.tableSection={filter:[`thead`,`tbody`,`tfoot`],replacement:function(e){return e}};function Q(e){var t=e.parentNode;return t.nodeName===`THEAD`||t.firstChild===e&&(t.nodeName===`TABLE`||ne(t))&&X.call(e.childNodes,function(e){return e.nodeName===`TH`})}function ne(e){var t=e.previousSibling;return e.nodeName===`TBODY`&&(!t||t.nodeName===`THEAD`&&/^\s*$/i.test(t.textContent))}function $(e,t){var n=Y.call(t.parentNode.childNodes,t),r=` `;return n===0&&(r=`| `),r+e+` |`}function re(e){for(var t in e.keep(function(e){return e.nodeName===`TABLE`&&!Q(e.rows[0])}),Z)e.addRule(t,Z[t])}function ie(e){e.addRule(`taskListItems`,{filter:function(e){return e.type===`checkbox`&&e.parentNode.nodeName===`LI`},replacement:function(e,t){return(t.checked?`[x]`:`[ ]`)+` `}})}function ae(e){e.use([q,J,re,ie])}export{B as n,ae as t};
...
describe("round-trip: inline marks", () => {
  ...
  test("inline math with single dollar fences", () => roundTripStable("let $x^2$ be positive"));
  test("inline math with double dollar fences", () => roundTripStable("value $$x+y$$ here"));
});
